...
export function calendarJs(I, ua, V) {
    function F(a, c, d) {
        ...
        d = p(d) ? d : !1;
        a = c;
        if (b.isWidget) mg = dc(v), lb || (Yd(!0), null !== z && (Yi(), Zi(), $i(), aj(), bj(), Oe || (Kh(), Oe = !0), cj(), Xd(), Ne())), ql(); else {
            v.setDate(1);
            v.setHours(0, 0, 0, 0);
            mg = ng(v);
            ...
            Ga();
            if (!lb && (Yd(), null !== z)) {
                r || (null === $d && ($d = h("div", "side-menu-disabled-background"), $d.onclick = Hb, z.appendChild($d)), rl());
                sl();
                tl();
                null === Ib && (Ib =
                    h("div", "full-month-view"), Ib.id = ec(), z.appendChild(Ib));
                ul();
                if (!r) {
                    var f = null !== mb;
                    if (b.views.fullMonth.isPinUpViewEnabled) {
                        ...
                        if (0 < f) for (var k = 0; k < f; k++) (new Image).src = b.views.fullMonth.pinUpViewImageUrls[k];
                        Zd || rb()
                    } else f && (Ib.removeChild(mb), mb = null)
                }
                f = null !== yc;
                b.views.fullMonth.showDayNamesHeaders ? (f && (yc.innerHTML = n.empty), f || (yc = h("div", "row-cells header-days"), Ib.appendChild(yc)), r && (yc.onclick = C),
                    Lh(yc)) : f && (Ib.removeChild(yc), yc = null);
                dj();
                vl();
                wl();
                xl();
            ...
            if (42 > k) {
                ...
                for (k += 1; 43 > k; k++) m = 1 === f, Mh(f, k, e.getMonth(), e.getFullYear(),
                    !0, m, Re.nextMonthDay), f++;
                f = ad(e.getFullYear(), e.getMonth());
                f = la.round(f / 2);
                Nh = new Date(e.getFullYear(), e.getMonth(), f)
            } else Nh = null;
            Ha();
            a && (Yi(), Zi(), $i(), aj(), bj(), yl(), zl(), Al(), Bl(), cj(), r || (Cl(), Dl(), El(), Fl()), null !== fc || r || (fc = h("div", "calendar-notification"), ya.push(fc), E.body.appendChild(fc)));
            d && La(!0, !1);
            null !== z && (Oh.innerText = Ph(b.views.fullMonth.titleBarDateFormat, v), c && R(b.viewToOpenOnFirstLoad) && (b.viewToOpenOnFirstLoad.toLowerCase() === tb.fullDay && b.views.fullDay.enabled ? Ua() : b.viewToOpenOnFirstLoad.toLowerCase() ===
            tb.fullWeek && b.views.fullWeek.enabled ? zc() : b.viewToOpenOnFirstLoad.toLowerCase() === tb.fullYear && b.views.fullYear.enabled ? Ac() : b.viewToOpenOnFirstLoad.toLowerCase() === tb.timeline && b.views.timeline.enabled ? Jb() : b.viewToOpenOnFirstLoad.toLowerCase() === tb.allEvents && b.views.allEvents.enabled && Qh()))
        }
    }

    function Xd() {
        pa(b.data) && q.addEvents(b.data, !1, !1, !1);
        if (b.useLocalStorageForEvents && Z.localStorage) for (var a = Z.localStorage.length, c = 0; c < a; c++) {
    ...
    function Yd(a) {
        ...
        if (null === z) {
            ...
            null !== b && ("input" !== b.tagName.toLowerCase() || "text" !== b.type && "date" !== b.type ? (z = b, z.className = a ? "calendar-widget" : "calendar", z.innerHTML = n.empty, z.oncontextmenu = function (a) {
                a.preventDefault()
            }, 100 <= bd(z, "height") ? z.className += n.space + "fixed-height" : z.style.removeProperty("height")) : Gl(b))
        }
    }

    function rl() {
        Zd || (ub =
            h("div", "side-menu custom-scroll-bars dark-thumb-scroll"), ub.onclick = C, z.appendChild(ub), Kb = h("div", "main-header"), ub.appendChild(Kb));
        Kb.innerHTML = n.empty;
        qa(Kb, b.sideMenuHeaderText);
        t(Kb, "ib-close", b.closeTooltipText, Hb);
        (b.configurationDialogEnabled || b.exportEventsEnabled || b.importEventsEnabled && b.manualEditingEnabled) && Kb.appendChild(h("div", "right-divider-line"));
        b.configurationDialogEnabled && t(Kb, "ib-octagon-hollow", b.configurationTooltipText, function () {
            Hb();
            gj()
        });
        (b.configurationDialogEnabled &&
            b.exportEventsEnabled || b.importEventsEnabled && b.manualEditingEnabled) && Kb.appendChild(h("div", "right-divider-line"));
        b.exportEventsEnabled && (cd = t(Kb, "ib-arrow-down-full-line", b.exportEventsTooltipText, function () {
            var a = Ma();
            null === a ? dd(ed) : a === W ? dd(gc) : a === da ? dd(hc) : a === ia ? dd(Bc) : a === ra && dd(Lb)
        }));
        b.importEventsEnabled && b.manualEditingEnabled && t(Kb, "ib-arrow-up-full-line", b.importEventsTooltipText, Hl);
        Zd || (Cc = h("div", "content"), ub.appendChild(Cc))
    }

    function hj(a) {
        var c = Te(Dc) || !0 === a, d = Te(fd, !0), e =
            Te(gd, !0), f = Te(Ec, !0);
        a = Te(Fc, !0);
        ...
        kd();
        var k = Ma();
        null === k ? Va(cd, 0 < ed.length) : k === W ? Va(cd, 0 < gc.length) : k === ra ? Va(cd, 0 < Lb.length) : k === da ? Va(cd, 0 < hc.length) : k === ia ? Va(cd, 0 < Bc.length) : Va(cd, !1);
        if (b.sideMenu.showDays) {
            ...
            jd.appendChild(Dc);
            if (b.startOfWeekDay === va.saturday ||
                b.startOfWeekDay === va.sunday) c = b.startOfWeekDay, A = !0;
            for (; c < k; c++) m = b.visibleDays.indexOf(c) > B.notFound, sb.push(K(Dc, b.dayNames[c], Ic, c.toString(), m, null, Jc)[0]);
            if (A) for (k = b.startOfWeekDay, c = 0; c < k; c++) A = b.visibleDays.indexOf(c) > B.notFound, sb.push(K(Dc, b.dayNames[c], Ic, c.toString(), A, null, Jc)[0]);
        ...
        if (b.sideMenu.showEventTypes) {
            ...
            c = !1;
            k = [];
            for (var g in N) N.hasOwnProperty(g) && (c || (Hc = h("div", "content-section content-section-opened"), Cc.appendChild(Hc),
                fd = h("div", "checkbox-container"), Ue(Hc, fd, b.eventTypesText, d, k), Hc.appendChild(fd), c = !0), sb = !0, p(O.visibleEventTypes) && (sb = O.visibleEventTypes.indexOf(parseInt(g)) > B.notFound), k.push(K(fd, N[g].text, Ic, g, sb, null, Jc)[0]))
        }
        if (b.sideMenu.showGroups && (c = e, c = p(c) ? c : !0, gd = Gc = null, g = ij(), e = g.length, 0 < e)) for (d = [], Gc = h("div", "content-section content-section-opened"), gd = h("div", "checkbox-container"), Cc.appendChild(Gc), Ue(Gc, gd, b.groupsText, c, d), Gc.appendChild(gd), c = 0; c < e; c++) k = g[c], sb = k.toLowerCase(), A = !0, p(O.visibleGroups) &&
        (A = O.visibleGroups.indexOf(sb) > B.notFound), d.push(K(gd, k, Ic, sb, A, null, Jc)[0]);
        if (b.sideMenu.showWorkingDays) {
            ...
            for (; f < g; f++) c = b.workingDays.indexOf(f) > B.notFound, e.push(K(Ec, b.dayNames[f], Ic, f.toString(), c, null, Jc)[0]);
            if (d) for (g =
                            b.startOfWeekDay, f = 0; f < g; f++) d = b.workingDays.indexOf(f) > B.notFound, e.push(K(Ec, b.dayNames[f], Ic, f.toString(), d, null, Jc)[0]);
        ...
        if (b.sideMenu.showWeekendDays) {
            ...
            hd.appendChild(Fc);
            if (b.startOfWeekDay === va.saturday || b.startOfWeekDay === va.sunday) a = b.startOfWeekDay + 1, e = !0;
            for (; a < f; a++) d = 6 < a ? 0 : a, c = b.weekendDays.indexOf(d) >
                B.notFound, g.push(K(Fc, b.dayNames[a - 1], Ic, d.toString(), c, null, Jc)[0]);
            if (e) for (f = b.startOfWeekDay + 1, a = 1; a < f; a++) e = 6 < a ? 0 : a, d = b.weekendDays.indexOf(e) > B.notFound, g.push(K(Fc, b.dayNames[a - 1], Ic, e.toString(), d, null, Jc)[0]);
    ...
    function Hb() {
        if (null !== ub) {
            ...
            if (pg) {
                ...
                if (null !== Gc) {
                    var d = Ve(Gc);
                    ae(O.visibleGroups, d) || (O.visibleGroups = [].slice.call(d), c = !0, x(b.events.onVisibleGroupsChanged, O.visibleGroups))
                }
                null !== Hc && (d = Ve(Hc, !0), ae(O.visibleEventTypes, d) || (O.visibleEventTypes = [].slice.call(d), c = !0, x(b.events.onVisibleEventTypesChanged, O.visibleEventTypes)));
                null !==
                jd && (d = Ve(jd, !0), 1 <= d.length && !ae(b.visibleDays, d) && (b.visibleDays = [].slice.call(d), od = [], c = a = !0));
                null !== id && (d = Ve(id, !0), ae(b.workingDays, d) || (b.workingDays = [].slice.call(d), c = a = !0));
    ...
    function Ue(a, c, d, e, f) {
        ...
        k.onclick = function () {
            ...
            b.sideMenu.showSelectAllNoneButtons && (A.style.display = d ? "block" : "none", g.style.display = d ? "block" : "none", n.style.display = d ? "block" : "none")
        };
        e || (c.style.display = "none", k.className = "text-header-closed", m.className = "ib-arrow-down-full", a.className = "content-section", b.sideMenu.showSelectAllNoneButtons &&
    ...
    function ql() {
        ...
        c.appendChild(h("div",
            "right-divider-line"));
        b.manualEditingEnabled && t(c, "ib-plus", b.addEventTooltipText, function () {
            P(null, new Date(v))
        });
    ...
    function Ll() {
        var a = h("div", "events custom-scroll-bars"), c = [];
        z.appendChild(a);
        Th(v, c);
        c = vb(c);
        var d = c.length;
        if (0 < d) for (var e = 0; e < d; e++) {
            var f = a, k = c[e], m = h("div", "event");
            f.appendChild(m);
            be(m, k, We(k, v));
            ce(m, k);
            m.id = "widget-day-" + k.id;
            m.setAttribute("event-type", H(k.type));
            m.setAttribute("event-id",
                k.id);
            ...
            if (!x(b.events.onWidgetEventRender, m, k)) {
                ...
                g = h("div", "duration");
                m.appendChild(g);
                k.from.getDate() === k.to.getDate() ? k.isAllDay ? Nb(A, k.from, null, " - " + b.allDayText) : (Nb(A, k.from, null,
                    " - " + de(k.from, k.to)), w(g, Ob(k.from, k.to))) : (Xe(A, k.from, k.to), w(g, Ob(k.from, k.to)));
                g.innerHTML === n.empty && m.removeChild(g);
                Ba(k.repeatEvery) && k.repeatEvery > y.never && (A = h("div", "repeats"), w(A, b.repeatsText.replace(":", n.empty) + n.space + pd(k.repeatEvery)), m.appendChild(A));
            ...
            f.scrollHeight > f.clientHeight && f.className.indexOf(" scroll-margin") === B.notFound &&
    ...
    function Gl(a) {
        ...
        c = Ye.value.split("/");
        a = null;
        3 === c.length && (c = new Date(parseInt(c[2]), parseInt(c[1]) - 1, parseInt(c[0])), c instanceof Date && !isNaN(c) && (a = c));
    ...
    function kj() {
        r && (b.exportEventsEnabled = !1, b.manualEditingEnabled = !1, b.fullScreenModeEnabled = !1, b.eventNotificationsEnabled = !1, b.views.fullMonth.showPreviousNextMonthNames =
            !1, b.views.fullMonth.showPreviousNextYears = !1, b.views.fullMonth.showExtraTitleBarButtons = !1, b.holidays = [])
    }

    function Ml(a) {
        C(a);
        qg("calendar calendar-shown", "calendar calendar-hidden");
        if (db) z.className = "calendar calendar-hidden", Ga(), x(b.events.onDatePickerClosed, za); else {
            ...
            z.style.top = a + "px";
            var c = Ze(z), d = mj();
            c.top - d.top + z.offsetHeight > Z.innerHeight ? (c = bd(z, "border-width"),
                d = bd(Lc, "border-width"), a -= z.offsetHeight + Lc.clientHeight + 4 * c + 2 * d, z.className += " calendar-shadow-top", z.style.top = a + "px") : z.className += " calendar-shadow-bottom"
        }
        db = !db
    }
    ...
    function nj(a) {
        var c = !0;
        null !== b.views.datePicker.minimumDate && (c = $e(b.views.datePicker.minimumDate,
            a));
    ...
    function Sl(a) {
        if (r) db && (a.keyCode === Q.escape ? (a.preventDefault(), qd()) : fa(a) && a.keyCode === Q.left ? (a.preventDefault(), tg()) : fa(a) && a.keyCode === Q.right ? (a.preventDefault(),
            ug()) : a.keyCode === Q.left ? (a.preventDefault(), bf()) : a.keyCode === Q.right ? (a.preventDefault(), cf()) : a.keyCode === Q.down && (a.preventDefault(), wg())); else if (Qe()) a.keyCode === Q.escape && Qe() && (a.preventDefault(), Hb()); else {
            if (sd) {
                var c = oj();
                fa(a) && a.keyCode === Q.left && c ? (a.preventDefault(), tg()) : fa(a) && a.keyCode === Q.right && c ? (a.preventDefault(), ug()) : a.keyCode === Q.escape ? !pj() && c && b.useEscapeKeyToExitFullScreenMode && Wa() : a.keyCode === Q.left && c ? qj(a) : a.keyCode === Q.right && c ? rj(a) : a.keyCode === Q.down && c ? sj(a) :
                    a.keyCode === Q.f5 && c && La(!1, !0)
            } else a.keyCode === Q.escape && pj();
            if (fa(a) && a.shiftKey && a.keyCode === Q.a) a.preventDefault(), b.manualEditingEnabled && P(null, new Date); else if (fa(a) && a.shiftKey && a.keyCode === Q.c) a.preventDefault(), tj(); else if (fa(a) && a.shiftKey && a.keyCode === Q.e) a.preventDefault(), b.exportEventsEnabled && (a = [], c = Ma(), null === c ? a = ed : c === W ? a = gc : c === da ? a = hc : c === ia ? a = Bc : c === ra && (a = Lb), 0 < a.length && dd(a)); else if (fa(a) && a.shiftKey && a.keyCode === Q.g) a.preventDefault(), b.configurationDialogEnabled &&
            gj(); else if (fa(a) && a.shiftKey && a.keyCode === Q.j) a.preventDefault(), ee(); else if (fa(a) && a.shiftKey && a.keyCode === Q.f) a.preventDefault(), a = !1, c = Ma(), null === c ? a = 0 < ed.length : c === W ? a = 0 < gc.length : c === da ? a = 0 < Lb.length : c === Da ? a = 0 < hc.length : c === ia && (a = 0 < Bc.length), a && fe(); else if (fa(a) && a.shiftKey && a.keyCode === Q.m) {
                if (a.preventDefault(), Xa(ra)) for (a = vg.length, c = 0; c < a; c++) vg[c]()
            } else fa(a) && a.shiftKey && a.keyCode === Q.o ? (a.preventDefault(), md() && Kc()) : fa(a) && a.shiftKey && a.keyCode === Q.v ? (a.preventDefault(), a =
                ja.length, Xa(W) && 0 < a && Yh(L, Pb)) : fa(a) && a.shiftKey && a.keyCode === Q.x ? (a.preventDefault(), tj(!0)) : fa(a) && a.shiftKey && a.keyCode === Q.f11 && (a.preventDefault(), Wa())
        }
    }
    ...
    function sl() {
        if (!r && b.views.fullDay.enabled) {
            ...
            df = h("div", "title");
            a.appendChild(df);
            t(a, "ib-close", b.closeTooltipText,
                Tl);
            a.appendChild(h("div", "right-divider-line"));
            b.views.fullDay.showExtraTitleBarButtons && b.fullScreenModeEnabled && ($h = t(a, "ib-arrow-expand-left-right", b.enableFullScreenTooltipText, Wa), a.appendChild(h("div", "right-divider-line-full-screen-mode")));
            t(a, "ib-arrow-right-full", b.nextDayTooltipText, yj);
            b.manualEditingEnabled && b.views.fullDay.showExtraTitleBarButtons && t(a, "ib-plus", b.addEventTooltipText, function () {
            ...
            (a.appendChild(h("div", "right-divider-line-views")), t(a, "ib-bar-graph", b.viewTimelineTooltipText, function () {
                Jb(L, !0)
            }));
            !r && md() && (t(a, "ib-hamburger", b.showMenuTooltipText, Kc), a.appendChild(h("div", "left-divider-line")));
            t(a, "ib-arrow-left-full", b.previousDayTooltipText, uj);
            b.views.fullDay.showExtraTitleBarButtons && (Hj = t(a, "ib-pin", b.todayTooltipText, Cj), b.jumpToDateEnabled && t(a, "ib-arrow-right-full-line", b.jumpToDateTitle, function () {
                ee()
            }), a.appendChild(h("div", "left-divider-line-events")), t(a, "ib-refresh",
                b.refreshTooltipText, function () {
                    La(!0, !0)
            ...
            wb.appendChild(he);
            b.manualEditingEnabled && b.dragAndDropForEventsEnabled &&
            (wa.ondragover = C, wa.ondragenter = C, wa.ondragleave = C, wa.ondrop = function (a) {
                Kj(a, L, wa)
            });
    ...
    function Vl(a, c) {
        var d = 0, e = Oc(a.seriesIgnoreDates),
            f = vd(c), k = new Date(c);
        if (ie(a) && e.indexOf(f) === B.notFound) {
            ...
            a.isAllDay ? Nc.appendChild(m) : (b.manualEditingEnabled && b.dragAndDropForEventsEnabled && (U(a.from, a.to) && (m.className += " resizable"), m.ondragstart = function (b) {
                var d = Ze(m);
                yg = m;
                zg = m.offsetTop;
                Qb = a;
                Ag = d.top - b.pageY;
                Bg = c
            }, m.ondragEnd = Wh, m.setAttribute("draggable",
                !0)), wa.appendChild(m));
            ...
            x(b.events.onFullDayEventRender, m, a) || (e = h("div", "title"), H(a.repeatEvery) > y.never && b.showReoccurringEventIcons && (k = h("div", "ib-refresh-medium ib-no-hover ib-no-active"), k.style.borderColor = m.style.color, e.appendChild(k)), e.innerHTML += kc(a.title), m.appendChild(e), a.isAllDay && !b.views.fullDay.showAllDayEventDetails) || (e = h("div", "date"), m.appendChild(e), k = h("div", "duration"),
                m.appendChild(k), a.from.getDate() === a.to.getDate() ? a.isAllDay ? w(e, b.allDayText) : (w(e, de(a.from, a.to)), w(k, Ob(a.from, a.to))) : (Xe(e, a.from, a.to), w(k, Ob(a.from, a.to))), k.innerHTML === n.empty && m.removeChild(k), b.views.fullDay.showEventUrls && Ca(a.url) && (e = h("div", "url-text"), w(e, Cg(a.url)), m.appendChild(e), e.onclick = function (b) {
                C(b);
                je(a.url)
            }), Ba(a.repeatEvery) && a.repeatEvery > y.never && (e = h("div", "repeats"), w(e, b.repeatsText.replace(":", n.empty) + n.space + pd(a.repeatEvery)), m.appendChild(e)), Ca(a.location) &&
            (e = h("div", "location"), w(e, a.location), m.appendChild(e)), Ca(a.description) && (e = h("div", "description"), w(e, a.description), m.appendChild(e)));
    ...
    function Ua(a, c) {
        ...
        if (0 <= b.workingDays.indexOf(X(a)) && null !== b.workingHoursStart && null !== b.workingHoursEnd) {
            var f = null;
            d = null;
            Pa(b.workingHoursStart) ? (e = X(L), b.workingHoursStart.hasOwnProperty(e.toString()) && (f = b.workingHoursStart[e.toString()])) : f = b.workingHoursStart;
            Pa(b.workingHoursEnd) ? (e = X(L), b.workingHoursEnd.hasOwnProperty(e.toString()) && (d = b.workingHoursEnd[e.toString()])) : d = b.workingHoursEnd;
            null !== f && null !== d && f !== d && (e = wa.offsetHeight / 1440, f = f.split(":"), d = d.split(":"), f = (60 * parseInt(f[0]) + parseInt(f[1])) * e, d = (60 * parseInt(d[0]) + parseInt(d[1])) * e - f, he.style.display = "block", he.style.top = f + "px", he.style.height = d + "px")
        }
        d = a;
        e = null;
        if (b.showHolidays) {
            ...
            for (var k = [], m = b.holidays.length, h = 0; h < m; h++) {
                var g = b.holidays[h], og = G(g.title, n.empty);
        ...
        c && (a = W, c = b.views.fullDay.showTimelineArrow, dc(L) && Xa(a) && c ? (a = Nc.offsetHeight, a = 1 >= a ? 4 * b.spacing : a, wb.scrollTop = d - a) : wb.scrollTop = e - wb.offsetHeight / 2);
    ...
    function Th(a, b) {
        xb(function (c) {
            ...
            d =
                H(c.repeatEvery);
            d > y.never && (d === y.everyDay ? nc(c, b, a, Ya, 1) : d === y.everyWeek ? nc(c, b, a, Rb, 1) : d === y.every2Weeks ? nc(c, b, a, Rb, 2) : d === y.everyMonth ? nc(c, b, a, ke, 1) : d === y.everyYear ? nc(c, b, a, wd, 1) : d === y.custom && (d = H(c.repeatEveryCustomType), f = H(c.repeatEveryCustomValue), 0 < f && (d === M.daily ? nc(c, b, a, Ya, f) : d === M.weekly ? nc(c, b, a, Rb, f) : d === M.monthly ? nc(c, b, a, ke, f) : d === M.yearly && nc(c, b, a, wd, f))))
        })
    }
    ...
    function Ul(a) {
        b.manualEditingEnabled && (a = xg(a, wa), b.useTemplateWhenAddingNewEvent ?
            (a = J(a[0]) + ":" + J(a[1]), a = td(L, L, a, a), P(a), ud()) : P(null, L, a))
    }
    ...
    function tl() {
        if (!r && b.views.fullWeek.enabled) {
            ...
            a || (da = h("div", "full-week-view"),
                da.id = ec(), z.appendChild(da));
            a = h("div", "title-bar");
            da.appendChild(a);
            b.fullScreenModeEnabled && (a.ondblclick = Wa);
            Qa = h("div", "title");
            ...
            a.appendChild(h("div", "right-divider-line"));
            b.views.fullWeek.showExtraTitleBarButtons && b.fullScreenModeEnabled && (bi = t(a, "ib-arrow-expand-left-right", b.enableFullScreenTooltipText, Wa), a.appendChild(h("div", "right-divider-line-full-screen-mode")));
            t(a, "ib-arrow-right-full", b.nextWeekTooltipText,
                zj);
            b.manualEditingEnabled && b.views.fullWeek.showExtraTitleBarButtons && t(a, "ib-plus", b.addEventTooltipText, function () {
                P(null, new Date(Sj))
            });
            !r && md() && (t(a, "ib-hamburger", b.showMenuTooltipText, Kc), a.appendChild(h("div", "left-divider-line")));
            t(a, "ib-arrow-left-full", b.previousWeekTooltipText, vj);
            b.views.fullWeek.showExtraTitleBarButtons && (t(a, "ib-pin", b.thisWeekTooltipText, Dj), b.jumpToDateEnabled && t(a, "ib-arrow-right-full-line", b.jumpToDateTitle, function () {
                ee()
    ...
    function Xl(a, c) {
        var d = h("div", Fg()), e = h("div", Fg()), f = new Date(a[c]);
        d.id = "calendar-week-day-" + c;
        e.id = "calendar-week-all-day-" + c;
        lf.appendChild(d);
        le.appendChild(e);
        d.ondblclick = function (a) {
            b.manualEditingEnabled && (a = xg(a, d), b.useTemplateWhenAddingNewEvent ? (a = J(a[0]) + ":" + J(a[1]), a = td(f, f,
                a, a), P(a), ud()) : P(null, f, a))
        };
        Gg(e, f.getFullYear(), f.getMonth(), f.getDate());
        Yl(d, c);
        dc(f) && Zl(d, f);
        b.manualEditingEnabled && b.dragAndDropForEventsEnabled && (d.ondragover = C, d.ondragenter = C, d.ondragleave = C, d.ondrop = function (a) {
            Kj(a, f, me)
        });
    ...
    function Yl(a,
        ...
        if (null !== b.workingHoursStart && null !== b.workingHoursEnd && 0 <= b.workingDays.indexOf(c)) {
            var d = Pa(b.workingHoursStart) && b.workingHoursStart.hasOwnProperty(c.toString()) ? b.workingHoursStart[c.toString()] : b.workingHoursStart;
            var e = Pa(b.workingHoursEnd) && b.workingHoursEnd.hasOwnProperty(c.toString()) ? b.workingHoursEnd[c.toString()] : b.workingHoursEnd;
            null !== d && null !== e && d !== e && (c = a.offsetHeight / 1440, d = d.split(":"), e = e.split(":"), d = (60 * parseInt(d[0]) + parseInt(d[1])) * c, c = (60 * parseInt(e[0]) + parseInt(e[1])) *
                c - d, e = h("div", "working-hours"), a.appendChild(e), e.style.display = "block", e.style.top = d + "px", e.style.height = c + "px")
        }
    }

    function Uj(a, c) {
        a.getFullYear() === c.getFullYear() ? (a.getMonth() === c.getMonth() ? (Nb(Qa, a), aa(Qa, " - "), Nb(Qa, c, null, n.space), aa(Qa, b.monthNames[a.getMonth()])) : (jc(Qa, a, !1, !1), aa(Qa, " - "), jc(Qa, c, !1, !1)), aa(Qa, ", " + a.getFullYear())) : (jc(Qa, a, !1, !0), aa(Qa, " - "), jc(Qa, c, !1, !0))
    }

    function oc(a, b, d, e, f) {
        for (var c = new Date(a.from), m = Oc(a.repeatEveryExcludeDays), h = !1; c < d;) {
            e(c, f);
            var g = !(!p(a.repeatEnds) ||
                $e(c, a.repeatEnds));
    ...
    function Vj(a, c, d, e) {
        var f = !1, k = Oc(d.seriesIgnoreDates), m = new Date(e), A = vd(m);
        e = new Date(e);
        if (ie(d) && k.indexOf(A) === B.notFound) {
            ...
            d.isAllDay ? (c.appendChild(g), di(g, d, m, c), ei = !0) : b.manualEditingEnabled && b.dragAndDropForEventsEnabled && !nf(d) && (U(d.from, d.to) && !d.isAllDay && (g.className += " resizable"), g.ondragstart = function (a) {
                var b = Ze(g);
                yg = g;
                zg = g.offsetTop;
                Qb = d;
                Ag = b.top - a.pageY;
                Bg = m
            }, g.ondragEnd = Wh, g.setAttribute("draggable", !0));
            hf(g, d);
            be(g, d, We(d, m));
            ce(g, d, e);
            U(d.from, m) && (g.id = "week-day-" + d.id);
            x(b.events.onFullWeekEventRender, g, d) || (c = h("div", "title"), H(d.repeatEvery) > y.never &&
            b.showReoccurringEventIcons && (k = h("div", "ib-refresh-medium ib-no-hover ib-no-active"), k.style.borderColor = g.style.color, c.appendChild(k)), c.innerHTML += kc(d.title), g.appendChild(c), d.isAllDay && !b.views.fullWeek.showAllDayEventDetails) || (c = h("div", "date"), g.appendChild(c), k = h("div", "duration"), g.appendChild(k), d.from.getDate() === d.to.getDate() ? d.isAllDay ? w(c, b.allDayText) : (w(c, de(d.from, d.to)), w(k, Ob(d.from, d.to))) : (Xe(c, d.from, d.to), w(k, Ob(d.from, d.to))), k.innerHTML === n.empty && g.removeChild(k), b.views.fullWeek.showEventUrls &&
            Ca(d.url) && (c = h("div", "url-text"), w(c, Cg(d.url)), g.appendChild(c), c.onclick = function (a) {
                C(a);
                je(d.url)
            }), Ba(d.repeatEvery) && d.repeatEvery > y.never && (c = h("div", "repeats"), w(c, b.repeatsText.replace(":", n.empty) + n.space + pd(d.repeatEvery)), g.appendChild(c)), Ca(d.location) && (c = h("div", "location"), w(c, d.location), g.appendChild(c)), Ca(d.description) && (c = h("div", "description"), w(c, d.description), g.appendChild(c)));
            ...
            d.isAllDay || fi.push({
                eventDetails: d,
                eventElement: g, height: g.offsetHeight
            });
    ...
    function zc(a, c) {
        ...
        0 < e.getDay() ? e.setDate(e.getDate() - e.getDay()) : b.startOfWeekDay === va.monday && e.setDate(e.getDate() - 7);
        b.startOfWeekDay === va.monday ? e.setDate(e.getDate() + 1) : b.startOfWeekDay === va.saturday && e.setDate(e.getDate() - 1);
        a = new Date(e);
        e = new Date(e);
        a.setHours(0, 0, 0, 0);
        ...
        if (!x(b.events.onFullWeekTitleRender, a, e)) {
            if (b.views.fullWeek.showWeekNumbersInTitles) {
                d = Qa;
                var f = b.weekText + n.space, k = new Date(a.getFullYear(), 0, 1),
        ...
        f = {};
        for (k = new Date(a); k <
        e;) f[X(k)] = new Date(k), k.setDate(k.getDate() + 1);
        lf.innerHTML = n.empty;
        le.innerHTML = n.empty;
        b.startOfWeekDay === va.saturday || b.startOfWeekDay === va.sunday ? (ci(b.startOfWeekDay, d, f), ci(0, b.startOfWeekDay, f)) : ci(0, d, f);
        b.reverseOrderDaysOfWeek && ld(lf);
        if (null !== yd && b.views.fullWeek.showDatesInDayHeaders) {
            d = new Date(a);
            f = 0;
            for (k = yd.children; d < e;) m = X(d), b.visibleDays.indexOf(m) > B.notFound && (k[f].innerHTML = b.views.fullWeek.padDayMonthNumbers ? k[f].innerHTML + (n.space + J(d.getDate()) + "/" + J(d.getMonth() + 1)) : k[f].innerHTML +
                (n.space + d.getDate() + "/" + (d.getMonth() + 1)), f++), d.setDate(d.getDate() + 1);
        ...
        for (k = 0; k < f; k++) {
            ...
            for (var h = Pc(m.from, m.to) + 1, g = new Date(m.from), q = !1, l = 0; l < h; l++) {
                if (g >= a && g <= e) {
                    var r = Aa("calendar-week-day-" + X(g)), t = Aa("calendar-week-all-day-" + X(g));
            ...
            g = H(m.repeatEvery);
            h = !1;
            g > y.never && (g === y.everyDay ? h = oc(m, a, e, Ya, 1) : g === y.everyWeek ? h = oc(m, a, e, Rb, 1) : g === y.every2Weeks ? h = oc(m, a, e, Rb, 2) : g === y.everyMonth ?
                h = oc(m, a, e, ke, 1) : g === y.everyYear ? h = oc(m, a, e, wd, 1) : g === y.custom && (g = H(m.repeatEveryCustomType), l = H(m.repeatEveryCustomValue), 0 < l && (g === M.daily ? h = oc(m, a, e, Ya, l) : g === M.weekly ? h = oc(m, a, e, Rb, l) : g === M.monthly ? h = oc(m, a, e, ke, l) : g === M.yearly && (h = oc(m, a, e, wd, l)))));
            h && !q && hc.push(m)
        }
        ...
        if (ei) {
            ...
            for (d = 0; d < e; d++) {
                ...
                k = f.length;
                for (q = m = 0; q < k; q++) m += f[q].offsetHeight +
                    b.spacing;
                a = la.max(a, m)
            }
    ...
    function ul() {
        ...
        r && (S.onclick = function (a) {
            C(a);
            Ga()
        });
        !r && md() && (t(S, "ib-hamburger", b.showMenuTooltipText,
            Kc), S.appendChild(h("div", "left-divider-line")));
        ...
        b.views.fullMonth.showExtraTitleBarButtons && (b.jumpToDateEnabled && t(S, "ib-arrow-right-full-line", b.jumpToDateTitle, function () {
            ee()
        }), S.appendChild(h("div", "left-divider-line-events")), t(S, "ib-refresh", b.refreshTooltipText, function () {
            La(!0,
                !0)
        ...
        b.views.fullMonth.showExtraTitleBarButtons && b.fullScreenModeEnabled && (Jg = t(S, "ib-arrow-expand-left-right", b.enableFullScreenTooltipText, Wa), S.appendChild(h("div", "right-divider-line-full-screen-mode")));
        ...
        b.manualEditingEnabled && t(S, "ib-plus", b.addEventTooltipText, function () {
            Wj(v, new Date) ? P(null) : P(null, new Date(v.getFullYear(), v.getMonth(), 1))
        });
        r || ((b.views.timeline.enabled || b.views.allEvents.enabled || b.views.fullYear.enabled || b.views.fullWeek.enabled || b.views.fullDay.enabled) && S.appendChild(h("div", "right-divider-line-views")), b.views.timeline.enabled && t(S, "ib-bar-graph", b.viewTimelineTooltipText, function () {
            var a = ng(v) ? null : v;
            Jb(a, !0)
        }), b.views.allEvents.enabled && t(S, "ib-eye", b.viewAllEventsTooltipText,
            function () {
                Qh(!0)
            }), b.views.fullYear.enabled && t(S, "ib-expand", b.viewFullYearTooltipText, function () {
            Ac(v.getFullYear(), !0)
        }), b.views.fullWeek.enabled && t(S, "ib-hamburger-side", b.viewFullWeekTooltipText, function () {
            var a = ng(v) ? null : v;
            zc(a, !0)
        }), b.views.fullDay.enabled && t(S, "ib-hourglass", b.viewFullDayTooltipText, function () {
            var a = ng(v) ? null : v;
            Ua(a, !0)
        }));
    ...
    function rb() {
        r || null === mb || (0 < b.views.fullMonth.pinUpViewImageUrls.length ? (mb.style.backgroundImage =
            "url('" + b.views.fullMonth.pinUpViewImageUrls[Qc] + "')", Qc++, Qc === b.views.fullMonth.pinUpViewImageUrls.length && (Qc = 0)) : 0 < b.views.fullMonth.pinUpViewImageCssClasses.length && (mb.className = "pin-up" + n.space + b.views.fullMonth.pinUpViewImageCssClasses[Qc], Qc++, Qc === b.views.fullMonth.pinUpViewImageCssClasses.length && (Qc = 0)), Xj())
    }
    ...
    function Xj() {
        if (!r && null !== mb && !x(b.events.onFullMonthPinUpRender, mb, v)) {
            ...
            if (null === gi || !U(gi, a)) {
                ...
                gi = a;
                var c = h("div", "pin-up-text"), d = h("div",
                    "day"), e = h("div", "month"), f = h("div", "year");
                c.onclick = function () {
                    P(null, a)
                };
    ...
    function dj(a, c) {
        ...
        for (e = 0; 6 > e; e++) {
            f =
                h("div", "row-cells days");
            a.appendChild(f);
            d || pf.push(f);
            for (var k = 0; 7 > k; k++) {
                var m = k;
                if (b.startOfWeekDay === va.saturday || b.startOfWeekDay === va.sunday) m = b.startOfWeekDay + k, 7 <= m && (m -= 7);
                if (b.visibleDays.indexOf(m) > B.notFound) {
                    ...
                    0 < b.views.fullMonth.minimumDayHeight && (g.style.height = b.views.fullMonth.minimumDayHeight + "px")
                }
            }
            b.reverseOrderDaysOfWeek &&
            ld(f)
        }
    }
    ...
    function $l(a) {
        ...
        Oh = h("span");
        oe.appendChild(Oh);
        b.views.fullMonth.showYearDropDownButtonIcon && (Lg = h("span", "ib-arrow-down-full-medium"), oe.appendChild(Lg))
    }

    function am(a) {
        var c = new Date(b.minimumYear, 1, 1), d = null;
        Tb = h("div", b.views.fullMonth.showMonthButtonsInYearDropDownMenu ? "years-drop-down" : "years-drop-down-no-months");
        a.appendChild(Tb);
        if (b.views.fullMonth.showMonthButtonsInYearDropDownMenu) for (a = 0; 12 > a; a++) 0 === a % 3 && (d = h("div", "months"), Tb.appendChild(d)), cm(d, a);
        qf = h("div", "contents custom-scroll-bars");
        for (Tb.appendChild(qf); !(dm(c.getFullYear()), wd(c), c.getFullYear() > b.maximumYear);) ;
    }

    function cm(a, c) {
        var d = h("div", "month-name"), e = b.monthNamesAbbreviated[c];
    ...
    function em() {
        var a = Tb.getElementsByClassName("year"), b = a.length;
        ...
        if (!r) {
            ...
            xb(function (a) {
                ...
                if (e.indexOf(a) === B.notFound) {
                    ...
                    null !== b && b.className.indexOf(" year-selected") === B.notFound && (b.className += " year-has-events");
                    e.push(a)
                }
            })
        }
    ...
    function sg() {
        var a = !1;
        Mg() && (b.views.fullMonth.showYearDropDownButtonIcon && (Lg.className = "ib-arrow-down-full-medium"), Tb.style.display = "none", a = !0);
        return a
    }
    ...
    function Mh(a, c, d, e, f, k, m) {
        c = Aa("calendar-day-" + c);
        if (null !== c) {
            var g = new Date, q = a === g.getDate() && e === g.getFullYear() && d === g.getMonth(), l = h("span"),
                t = new Date(e, d, a);
            ...
            r ? (g = nj(t), g || (c.className += " cell-no-click", l.className = "no-click")) : l.className = n.empty;
            l.className += f;
            l.className +=
                q && !r ? " today" : n.empty;
            l.innerText = b.views.fullMonth.padDayNumbers ? J(a) : a;
            1 !== a || r || (l.className += " first-day");
            0 <= b.weekendDays.indexOf(t.getDay()) && c.className.indexOf("weekend-day") === B.notFound && (c.className += " weekend-day");
            0 <= b.workingDays.indexOf(X(t)) && c.className.indexOf("working-day") === B.notFound && (c.className += " working-day");
            ...
            c.appendChild(h("span",
                "blank"));
            b.views.fullDay.enabled && (l = h("div", "ib-arrow-expand-left-right-icon"), c.appendChild(l), Ra(l, b.expandDayTooltipText), l.onclick = function () {
                Ua(t, !0)
            });
            k && b.views.fullMonth.showPreviousNextMonthNames && (k = b.monthNames[d], b.views.fullMonth.showPreviousNextYears && (m === Re.previousMonthDay && 11 === d || m === Re.nextMonthDay && 0 === d) && (k += n.space + e.toString()), aa(c, k, "month-name" + f, function () {
                1 === a ? cf() : bf()
            }, !0, !0));
            fm(t, f, c);
            ...
            r && (c.onclick = g ? function (a) {
                C(a);
                Mg() ? Ga() : (a = new Date(t), a.setHours(0, 0, 0, 0), qd(), Uh(t), x(b.events.onDatePickerDateChanged, a), Mc = a)
            } : C);
    ...
    function Ha() {
        for (var a = 0; 6 > a; a++) for (var c = 0; 7 > c; c++) {
        ...
        for (d = 0; d < c; d++) {
            ...
            hi(f.from, f);
            if (f.from.getDate() !==
                f.to.getDate() || f.from.getMonth() !== f.to.getMonth() || f.from.getFullYear() !== f.to.getFullYear()) {
                var k = Pc(f.from, f.to);
                if (0 < k) for (var m = new Date(f.from), h = 0; h < k; h++) Ya(m), ii(vd(m), f.id), null !== ji(m) && hi(m, f)
            }
            ie(e) && ed.push(e);
            f = H(e.repeatEvery);
            f > y.never && (f === y.everyDay ? pc(e, Ya, 1) : f === y.everyWeek ? pc(e, Rb, 1) : f === y.every2Weeks ? pc(e, Rb, 2) : f === y.everyMonth ? pc(e, ke, 1) : f === y.everyYear ? pc(e, wd, 1) : f === y.custom && (f = H(e.repeatEveryCustomType), k = H(e.repeatEveryCustomValue), 0 < k && (f === M.daily ? pc(e, Ya, k) : f === M.weekly ?
                pc(e, Rb, k) : f === M.monthly ? pc(e, ke, k) : f === M.yearly && pc(e, wd, k))))
        }
    ...
    function hi(a, c) {
        var d = ji(a), e = Oc(c.seriesIgnoreDates), f = vd(a), k = new Date(a);
        if (ie(c) && e.indexOf(f) ===
            B.notFound && (ii(f, c.id), null !== d && (gm(a, c), !r))) if (d.getElementsByClassName("event").length < b.views.fullMonth.maximumEventsPerDayDisplay || 0 >= b.views.fullMonth.maximumEventsPerDayDisplay || b.views.fullMonth.useOnlyDotEvents) {
            e = h("div", "event");
            e.setAttribute("event-type", H(c.type));
            e.setAttribute("event-id", c.id);
            e.setAttribute("event-is-all-day", c.isAllDay);
            if (b.views.fullMonth.useOnlyDotEvents) e.className += " event-circle"; else if (!x(b.events.onFullMonthEventRender, e, c)) {
                var m = c.title, g = H(c.repeatEvery);
                b.views.fullMonth.showTimesInEvents && !c.isAllDay && c.from.getDate() === c.to.getDate() && (m = de(c.from, c.to) + ": " + m);
                g > y.never && b.showReoccurringEventIcons && (g = h("div", "ib-refresh-small ib-no-hover ib-no-active"), g.style.borderColor = e.style.color, e.appendChild(g));
                e.innerHTML += kc(m)
            }
            d.appendChild(e);
            di(e, c, a, d);
    ...
    function hm(a, c) {
        ...
        if (null === d) {
            ...
            d.ondblclick = C;
            a.appendChild(d);
            if (b.views.fullMonth.applyCssToEventsNotInCurrentMonth && c.getMonth() !== v.getMonth() || c.getFullYear() !== v.getFullYear()) d.className += " day-muted";
            w(d, "+1 " + b.moreText);
            b.views.fullDay.enabled ? d.onclick = function () {
                Ua(e,
                    !0)
            } : d.className += n.space + "prevent-pointer-events"
        } else a = parseInt(d.getAttribute("events")) + 1, d.setAttribute("events", a.toString()), w(d, "+" + a + n.space + b.moreText)
    }

    function ji(a) {
        var b = new Date(v.getFullYear(), v.getMonth(), 1);
        var d = new Date(v);
        var e = new Date(v), f = null, k = 0;
        b = X(b);
        d.setMonth(d.getMonth() + 1);
        e.setMonth(e.getMonth() - 1);
        a.getMonth() === d.getMonth() && a.getFullYear() === d.getFullYear() ? (d = b + ad(v.getFullYear(), v.getMonth()), k = Pe(a.getDate() + d)) : a.getMonth() === e.getMonth() && a.getFullYear() ===
        e.getFullYear() ? k = Pe(b - Pc(a, v) + 1) : a.getMonth() === v.getMonth() && a.getFullYear() === v.getFullYear() && (d = b, k = Pe(a.getDate() + d));
    ...
    function vl() {
        if (!r && b.views.fullYear.enabled) {
            ...
            b.views.fullYear.showExtraTitleBarButtons && (t(a, "ib-pin", b.currentYearTooltipText, Ej), b.jumpToDateEnabled && t(a, "ib-arrow-right-full-line", b.jumpToDateTitle, function () {
                ee()
            }), a.appendChild(h("div", "left-divider-line-events")), t(a, "ib-refresh", b.refreshTooltipText, function () {
                La(!0, !0)
            }));
            t(a, "ib-close", b.closeTooltipText,
                function () {
            ...
            a.appendChild(h("div", "right-divider-line"));
            b.views.fullYear.showExtraTitleBarButtons && b.fullScreenModeEnabled && (mi = t(a, "ib-arrow-expand-left-right", b.enableFullScreenTooltipText, Wa), a.appendChild(h("div", "right-divider-line-full-screen-mode")));
            t(a, "ib-arrow-right-full", b.nextYearTooltipText, Aj);
            b.views.fullYear.showExtraTitleBarButtons && b.manualEditingEnabled && t(a, "ib-plus", b.addEventTooltipText, function () {
    ...
    function im(a) {
        var c = new Date(sa, a, 1), d = function () {
            U(v, c) || (F(c), rb());
        ...
        b.manualEditingEnabled && (k.appendChild(h("div", "right-divider-line")), t(k, "ib-plus", b.addEventTooltipText, function () {
            P(null, c)
        }));
    ...
    function wl() {
        if (!r &&
            ...
            b.views.allEvents.showExtraTitleBarButtons && (a.appendChild(h("div", "right-divider-line")), b.fullScreenModeEnabled && (oi = t(a, "ib-arrow-expand-left-right", b.enableFullScreenTooltipText,
                Wa), a.appendChild(h("div", "right-divider-line-full-screen-mode"))), b.manualEditingEnabled && t(a, "ib-plus", b.addEventTooltipText, function () {
                P(null)
            }));
            !r && md() && t(a, "ib-hamburger", b.showMenuTooltipText, Kc);
            b.views.allEvents.showExtraTitleBarButtons && (a.appendChild(h("div", "left-divider-line-events")), t(a, "ib-refresh", b.refreshTooltipText, function () {
                La(!0, !0)
    ...
    function pm(a) {
        if (ie(a)) {
            ...
            if (!x(b.events.onAllEventsEventRender, d, a)) {
                ...
                e = h("div", "duration");
                d.appendChild(e);
                a.from.getDate() === a.to.getDate() ? a.isAllDay ? Nb(c, a.from, null, " - " + b.allDayText) : (Nb(c, a.from, null, " - " + de(a.from, a.to)), w(e, Ob(a.from, a.to))) : (Xe(c, a.from, a.to), w(e, Ob(a.from, a.to)));
                e.innerHTML === n.empty && d.removeChild(e);
                b.views.allEvents.showEventUrls && Ca(a.url) && (c = h("div", "url-text"), w(c, Cg(a.url)), d.appendChild(c), c.onclick = function (b) {
                    C(b);
                    je(a.url)
                });
                Ba(a.repeatEvery) && a.repeatEvery > y.never &&
                (c = h("div", "repeats"), w(c, b.repeatsText.replace(":", n.empty) + n.space + pd(a.repeatEvery)), d.appendChild(c));
    ...
    function qm(a) {
        var c = "month-" + a.getMonth() + "-" + a.getFullYear(), d = Aa(c);
        if (null === d) {
            ...
            b.manualEditingEnabled && t(m, "ib-close", b.removeEventsTooltipText,
                function () {
                    ak(e, Wj)
                });
            f = function () {
                var a = p, e = d;
                "none" !== e.style.display ? (e.style.display = "none", a.className = "ib-square-hollow", O.visibleAllEventsMonths[c] = !1, Ra(a, b.restoreTooltipText)) : (e.style.display = "block", a.className = "ib-minus", O.visibleAllEventsMonths[c] = !0, Ra(a, b.minimizedTooltipText))
            };
            ...
            d.id = c;
            k.appendChild(d);
            O.visibleAllEventsMonths.hasOwnProperty(c) && !O.visibleAllEventsMonths[c] && (d.style.display = "none", p.className =
                "ib-square-hollow", Ra(p, b.restoreTooltipText));
    ...
    function xl() {
        if (!r && b.views.timeline.enabled) {
            ...
            a.appendChild(h("div", "right-divider-line"));
            b.views.timeline.showExtraTitleBarButtons && b.fullScreenModeEnabled && (qi = t(a, "ib-arrow-expand-left-right", b.enableFullScreenTooltipText, Wa), a.appendChild(h("div", "right-divider-line-full-screen-mode")));
            t(a, "ib-arrow-right-full", b.nextYearTooltipText, Bj);
            b.views.timeline.showExtraTitleBarButtons && b.manualEditingEnabled && t(a, "ib-plus", b.addEventTooltipText, function () {
                P(null, new Date(ba))
            });
            b.views.fullDay.enabled && (a.appendChild(h("div",
                "right-divider-line-views")), t(a, "ib-hourglass", b.viewFullDayTooltipText, function () {
                Ua(ba, !0)
            }));
            !r && md() && (t(a, "ib-hamburger", b.showMenuTooltipText, Kc), a.appendChild(h("div", "left-divider-line")));
            t(a, "ib-arrow-left-full", b.previousYearTooltipText, xj);
            b.views.timeline.showExtraTitleBarButtons && (bk = t(a, "ib-pin", b.currentYearTooltipText, Fj), b.jumpToDateEnabled && t(a, "ib-arrow-right-full-line", b.jumpToDateTitle, function () {
                ee()
            }), a.appendChild(h("div", "left-divider-line-events")), t(a, "ib-refresh", b.refreshTooltipText,
                function () {
                    La(!0, !0)
    ...
    function tm(a, c) {
        var d = h("div", "event"), e = vd(ba), f = new Date(ba);
        ...
        if (!x(b.events.onTimelineEventRender, d, c)) {
            if (H(c.repeatEvery) > y.never && b.showReoccurringEventIcons) {
                var k =
                    h("div", "ib-refresh-medium ib-no-hover ib-no-active");
    ...
    function Jb(a, c) {
        a = p(a) ? new Date(a) : new Date;
        c = p(c) ? c : !1;
        var d = new Date, e = X(d), f = b.visibleDays.indexOf(e) >
            B.notFound, k = [];
        e = Ja.scrollLeft;
        var m = Ja.scrollTop;
        ...
        d = n.empty;
        "group" === Za ? d = b.groupText : "organizerName" === Za ? d = b.organizerNameText : "location" === Za ? d = b.locationText : "organizerEmailAddress" === Za ? d = b.organizerEmailAddressText : "url" === Za ? d = b.urlText : "title" === Za ? d = b.titleText : "description" === Za && (d = b.descriptionText);
        a.innerHTML = d;
        Fd.appendChild(a);
        ...
        a = k.length;
        d = 0;
        if (0 < a) for (f = 0; f < a; f++) {
            g = k[f];
            l = G(g[Za], b.noneText);
            q = l.toLowerCase();
            g.isAllDay && (l = b.allDayText + ": " + l, q = q + "-" + g.id);
            if (Qg.hasOwnProperty(q)) l = Qg[q]; else {
        ...
        d = a.length;
        f = 0;
        0 < d && (f = bd(a[0], "border-bottom-width"), g = bd(Fd, "border-bottom-width"), f = d * (a[0].offsetHeight - f) +
            (Fd.offsetHeight - g));
        for (a = 0; a < k; a++) d = uf[a], 0 === f && (f = Ja.scrollHeight - d.offsetTop), d.style.height = f + "px";
    ...
    function xj() {
        Eg(ba);
        if (7 > b.visibleDays.length) for (var a = X(ba); b.visibleDays.indexOf(a) === B.notFound;) Eg(ba), a = X(ba);
        Jb(ba, !0)
    }
    ...
    function dk(a) {
        a = p(a) ? a : !1;
        Ya(ba);
        if (7 > b.visibleDays.length) for (var c = X(ba); b.visibleDays.indexOf(c) === B.notFound;) Ya(ba), c = X(ba);
        a && Jb(ba, !0)
    }
    ...
    function Cl() {
        ...
        b.manualEditingEnabled && xa(Ia, "ib-plus-icon", b.addEventTitle + "...", function () {
            if (b.useTemplateWhenAddingNewEvent) {
                var a = td(Gd, Gd);
                P(a);
                ud()
        ...
        b.views.fullDay.enabled && ($a(Ia),
            xa(Ia, "ib-arrow-expand-left-right-icon", b.expandDayTooltipText, function () {
                Ua(Gd, !0)
            }));
        b.views.fullWeek.enabled && ($a(Ia), xa(Ia, "ib-hamburger-side-icon", b.viewFullWeekText, function () {
            zc(Gd, !0)
        }));
        b.manualEditingEnabled && (ri = $a(Ia), Rg = xa(Ia, "ib-circle-icon", b.pasteText, function () {
            Yh(Gd, Pb)
        }))
    }

    function Ng(a, b) {
        r || null === Ia || (fa(a) || mc(), Gd = new Date(b), null !== Rg && (b = 0 < ja.length ? "block" : "none", ri.style.display = b, Rg.style.display = b), Ga(), C(a), vf(a, Ia))
    }

    function Dl() {
        null !== Y && (gb(E.body, Y), Sg = Tg = wf = xf =
            yf = zf = Af = Bf = Cf = Df = Ef = Ff = Y = null);
        Y = h("div", "calendar-context-menu");
        ya.push(Y);
        E.body.appendChild(Y);
        b.manualEditingEnabled && (yf = xa(Y, "ib-edit-icon", b.editEventTitle + "...", function () {
            P(ab, null, null, fk)
        }, !0), Cf = $a(Y), Bf = xa(Y, "ib-pipe-icon", b.cutText, function () {
            ge();
            Pb = !0;
            gk(ab);
            ge(!1)
        }), Af = $a(Y), zf = xa(Y, "ib-circle-hollow-icon", b.copyText, function () {
            ge();
            Pb = !1;
            gk(ab);
            ge(!1)
        }), Ef = $a(Y), Df = xa(Y, "ib-equals-icon", b.duplicateText + "...", function () {
            P(ab);
        ...
        }), xf = $a(Y), wf = xa(Y, "ib-close-icon", b.removeEventText, function () {
            Ub(E.body, Ka);
            var a = function () {
                gb(E.body, Ka)
            }, c = H(ab.repeatEvery) > y.never && null !== Hf;
            If(b.confirmEventRemoveTitle, b.confirmEventRemoveMessage, function () {
                a();
                p(ab.id) && (Vg.checked || null === Hf ? (q.removeEvent(ab.id, !0), Sa(b.eventRemovedText.replace("{0}", ab.title))) : (pa(ab.seriesIgnoreDates) ? ab.seriesIgnoreDates.push(Hf) : ab.seriesIgnoreDates = [Hf], Ha()), ma())
            }, a, c)
        }), Ff = $a(Y));
        si =
            xa(Y, "ib-arrow-top-right-icon", b.openUrlText, function () {
                je(ab.url)
            });
        b.exportEventsEnabled && (Tg = $a(Y), Sg = xa(Y, "ib-arrow-down-full-line-icon", b.exportEventsTooltipText + "...", function () {
            dd(Ea)
        }));
        b.shareEventsEnabled && Jf.share && ($a(Y), xa(Y, "ib-arrow-up-full-line-share-icon", b.shareText + "...", function () {
            var a = hk(0 < Ea.length ? Ea : [ab]), c = {type: "text/plain"};
            a = new Blob([a], c);
    ...
    function gf(a, c, d) {
        if (null !== Y) {
            ...
            fk = new Date(d);
            Hf = p(d) ? d : null;
            1 < Ea.length ? (b.manualEditingEnabled && (yf.style.display = "none", Cf.style.display = "none", Bf.style.display = "block", Af.style.display = "block", zf.style.display = "block", Ef.style.display = "none", Df.style.display = "none", xf.style.display = "none", wf.style.display = "none"), Ff.style.display = "none", si.style.display = "none", b.exportEventsEnabled && (Tg.style.display = "block", Sg.style.display = "block")) : (f ? b.manualEditingEnabled && (yf.style.display = "block", Cf.style.display =
                "none", Bf.style.display = "none", Af.style.display = "none", zf.style.display = "none", Ef.style.display = "none", Df.style.display = "none", xf.style.display = "block", wf.style.display = "block", Ff.style.display = e !== n.empty ? "block" : "none") : b.manualEditingEnabled && (yf.style.display = "block", Cf.style.display = "block", Bf.style.display = "block", Af.style.display = "block", zf.style.display = "block", Ef.style.display = "block", Df.style.display = "block", xf.style.display = "block", wf.style.display = "block", Ff.style.display = e !== n.empty ?
                "block" : "none"), si.style.display = e !== n.empty ? "block" : "none", b.exportEventsEnabled && (Tg.style.display = "none", Sg.style.display = "none"));
    ...
    function El() {
        ...
        b.manualEditingEnabled && (Oa = h("div", "calendar-context-menu"), ya.push(Oa), E.body.appendChild(Oa), xa(Oa, "ib-plus-icon", b.addEventTitle + "...", function () {
            if (b.useTemplateWhenAddingNewEvent) {
            ...
            ui = xa(Oa, "ib-close-icon", b.removeEventsTooltipText, function () {
                ak(ue, U)
            }), ti = $a(Oa), Wg = xa(Oa, "ib-circle-icon", b.pasteText, function () {
            Yh(ue, Pb)
        }))
    }

    function Jj(a, b, d) {
        null !== Oa && (fa(a) || mc(), ue = b, null !== Wg && (b = 0 < ja.length ? "block" : "none", ti.style.display = b, Wg.style.display = b), d = pa(d) && 0 < d.length ? "block" : "none", vi.style.display = d, ui.style.display = d, Ga(), C(a), vf(a, Oa))
    }

    function Fl() {
        null === nb && (nb = h("div", "calendar-context-menu"), ya.push(nb), E.body.appendChild(nb), jk = xa(nb, "ib-close-icon", b.hideDayText,
            function () {
                b.visibleDays.splice(b.visibleDays.indexOf(kk), 1);
                lb = !1;
                x(b.events.onOptionsUpdated, b);
                F(v, !0, !0)
            }, !0), lk = $a(nb), mk = xa(nb, "ib-rhombus-hollow-icon", b.showOnlyWorkingDaysText, function () {
            1 <= b.workingDays.length && (b.visibleDays = [].slice.call(b.workingDays), lb = !1, x(b.events.onOptionsUpdated, b), F(v, !0, !0))
        }), nk = $a(nb), xa(nb, "ib-octagon-hollow-icon", b.visibleDaysText + "...", function () {
            Kc(!0)
        }))
    }
    ...
    function Zi() {
        if (!r) {
            null === bb && (bb =
                h("div", "calendar-dialog event-editor"), ya.push(bb), E.body.appendChild(bb));
    ...
    function zm() {
        ...
        (Md.maxLength = b.maximumEventLocationLength)
    }
    ...
    function qk(a) {
        a = p(a) ? a : ea;
        var b = !1;
        (a = p(a) && ib(a.locked) ? a.locked : !1) ? b = !0 : ye.checked && (hb.value = Wb.value, Xb.value = "00:00", Yb.value = "23:59", b = !0);
        hb.disabled = b;
        Xb.disabled = b;
        Yb.disabled = b;
        var d = Ae(Wb), e = Ae(hb);
    ...
    function P(a, c, d, e) {
        if (Zh(b.events.onBeforeEventAddEdit)) x(b.events.onBeforeEventAddEdit, a); else {
            Ub(E.body, Ka);
            var f = bb, k = void 0;
            k = p(k) ? k : 0;
            ...
            Yg.appendChild(k);
            for (var m in N) N.hasOwnProperty(m) && (N[m].eventEditorInput = ha(k,
                N[m].text, "Type"));
            p(a) ? (w(Sc, b.editEventTitle), sk(a.type), Gf.value = b.updateText, Ug.style.display = "inline-block", ea = a, Xb.value = yb(a.from, !1), Yb.value = yb(a.to, !1), ye.checked = xi(a.isAllDay), Kf.checked = xi(a.showAlerts, !0), Lf.checked = xi(a.showAsBusy, !0), Ab.value = G(a.title), Ld.value = G(a.description), Md.value = G(a.location), Kd.value = G(a.group), ze.value = G(a.url), Be.value = G(a.color, b.defaultEventBackgroundColor), Ce.value = G(a.colorText, b.defaultEventTextColor), De.value = G(a.colorBorder, b.defaultEventBorderColor),
                Wc.value = H(a.repeatEveryCustomValue, 1), Jd.value = H(a.alertOffset, 0), Bb(a.from, Wb), Bb(a.to, hb), d = H(a.repeatEvery), d === y.never ? qc.checked = !0 : d === y.everyDay ? Mf.checked = !0 : d === y.everyWeek ? Nf.checked = !0 : d === y.every2Weeks ? Of.checked = !0 : d === y.everyMonth ? Pf.checked = !0 : d === y.everyYear ? Qf.checked = !0 : d === y.custom && (Zb.checked = !0), c = H(a.repeatEveryCustomType), c === M.daily ? Id.checked = !0 : c === M.weekly ? Rf.checked = !0 : c === M.monthly ? Sf.checked = !0 : c === M.yearly && (Tf.checked = !0), c = Oc(a.repeatEveryExcludeDays), ah.checked =
                c.indexOf(1) > B.notFound, bh.checked = c.indexOf(2) > B.notFound, ch.checked = c.indexOf(3) > B.notFound, dh.checked = c.indexOf(4) > B.notFound, eh.checked = c.indexOf(5) > B.notFound, fh.checked = c.indexOf(6) > B.notFound, gh.checked = c.indexOf(0) > B.notFound, Bb(a.repeatEnds, Nd), yi = d > y.never && p(e) && !U(a.from, e), Uf = e) : (e = new Date, c = p(c) ? c : e, dc(c) && (c.setHours(e.getHours()), c.setMinutes(e.getMinutes())), e = fb(c, b.defaultEventDuration), w(Sc, b.addEventTitle), sk(), Gf.value = b.addText, Ug.style.display = "none", ea = {}, ye.checked = !1, Kf.checked =
                !0, Lf.checked = !0, Ab.value = n.empty, Ld.value = n.empty, Md.value = n.empty, Kd.value = n.empty, ze.value = n.empty, Be.value = b.defaultEventBackgroundColor, Ce.value = b.defaultEventTextColor, De.value = b.defaultEventBorderColor, qc.checked = !0, ah.checked = !1, bh.checked = !1, ch.checked = !1, dh.checked = !1, eh.checked = !1, fh.checked = !1, gh.checked = !1, Nd.value = null, Wc.value = "1", Id.checked = !0, Jd.value = 0, pa(d) && (c.setHours(d[0]), c.setMinutes(d[1]), e.setHours(d[0]), e.setMinutes(d[1]), e = fb(e, b.defaultEventDuration)), Xb.value = yb(c, !1),
                Yb.value = yb(e, !1), Bb(c, Wb), Bb(e, hb), yi = !1, Uf = null);
            t(Sc, "ib-close", b.closeTooltipText, Tc, !0);
            a = nf(a);
    ...
    function pk() {
        var a = Xb.value.split(":"), c = Yb.value.split(":"), d = Od(Ab.value), e = Od(ze.value);
        if (2 > a.length) Vf(b.fromTimeErrorMessage); else if (2 > c.length) Vf(b.toTimeErrorMessage); else if (d === n.empty) Vf(b.titleErrorMessage); else if (0 < e.length && !tk(e)) Vf(b.urlErrorMessage); else {
            var f = Ae(Wb), k = Ae(hb), m = Od(Ld.value), h = Od(Md.value), g = Od(Kd.value), l = Ae(Nd, null),
                r = parseInt(Wc.value), t = Dm(),
                u = parseInt(Jd.value);
            isNaN(r) && (r = 0, qc.checked = !0, Id.checked = !0);
            isNaN(u) && (u = 0);
            if (k < f) Vf(b.toSmallerThanFromErrorMessage); else {
                var x = function (a, c, f, k, A) {
                    A = p(A) ? A : !1;
                    hh(c, Xb.value);
                    hh(f, Yb.value);
                    A ? (ea.from = c, ea.to = f, ea.repeatEnds = k) : (A = p(a), c = {
                        from: c,
                        to: f,
                        title: d,
                        description: m,
                        ...
                        alertOffset: u
                    }, qc.checked ? c.repeatEvery = y.never : Mf.checked ? c.repeatEvery = y.everyDay : Nf.checked ? c.repeatEvery = y.everyWeek : Of.checked ? c.repeatEvery = y.every2Weeks : Pf.checked ? c.repeatEvery = y.everyMonth : Qf.checked ? c.repeatEvery = y.everyYear : Zb.checked && (c.repeatEvery = y.custom), Id.checked ? c.repeatEveryCustomType = M.daily : Rf.checked ? c.repeatEveryCustomType = M.weekly : Sf.checked ? c.repeatEveryCustomType = M.monthly : Tf.checked && (c.repeatEveryCustomType = M.yearly), A ? c.id = a : (c.organizerName =
                        b.organizerName, c.organizerEmailAddress = b.organizerEmailAddress), A ? (q.updateEvent(a, c, !1), Sa(b.eventUpdatedText.replace("{0}", ea.title))) : (q.addEvent(c, !1), Sa(b.eventAddedText.replace("{0}", c.title))), b.isWidget ? F(v) : (Ha(), ma()))
                };
                yi ? (Wf(), If(b.confirmEventUpdateTitle, b.confirmEventUpdateMessage, function () {
                    var a = new Date(Uf), b = new Date(Uf), c = new Date(Uf);
                    Pd();
                    Ya(c, -1);
                    x(ea.id, f, k, c, !0);
                    x(null, a, b, l);
                    ...
                    x(ea.id, f, k, l);
                    Tc()
                }, !1, !0, b.forwardText, b.seriesText)) : (x(ea.id, f, k, l), Tc())
            }
        }
    }
    ...
    function Am() {
        ...
        If(b.confirmEventRemoveTitle, b.confirmEventRemoveMessage, function () {
            Pd();
            Tc();
            p(ea.id) && (q.removeEvent(ea.id, !0), b.isWidget ? F(v) : ma(), Sa(b.eventRemovedText.replace("{0}", ea.title)))
        }, function () {
            Pd()
        })
    }
    ...
    function If(a, c, d, e, f, k, m, g) {
        f = p(f) ? f : !1;
        k = p(k) ? k : !0;
        var A = p(m) ? m : b.yesText, l = p(g) ? g : b.noText;
        ...
        p(m) || p(g) || (k ? (A.style.display = "inline-block", q.value = b.yesText) :
    ...
    function vk() {
        kh();
        Ci.checked ? vc(uc, "csv", Ta.value, Cb.checked) : xk.checked ? vc(uc, "xml", Ta.value, Cb.checked) : yk.checked ? vc(uc, "json",
            Ta.value, Cb.checked) : zk.checked ? vc(uc, "text", Ta.value, Cb.checked) : Ak.checked ? vc(uc, "ical", Ta.value, Cb.checked) : Bk.checked ? vc(uc, "md", Ta.value, Cb.checked) : Ck.checked ? vc(uc, "html", Ta.value, Cb.checked) : Dk.checked && vc(uc, "tsv", Ta.value, Cb.checked)
    }
    ...
    function zl() {
        if (!r && null === ka) {
            ...
            a.ondblclick = Ei;
            var c = t(a, "ib-close", b.closeTooltipText,
                kd);
            c.onmousedown = C;
            c.onmouseup = C;
            ...
            oh = K(d, b.locationText.replace(":", n.empty),
                ac)[0];
    ...
    function fe() {
        "block" !== ka.style.display && (Db = [], ka.style.display = "block", Fe(!1), na.value = u.lastSearchText, mh.checked = u.not, nh.checked = u.matchCase, Ge.checked = u.showAdvanced, $f.checked = u.searchTitle, oh.checked = u.searchLocation, ph.checked = u.searchDescription,
            qh.checked = u.searchGroup, rh.checked = u.searchUrl, sh.checked = u.startsWith, th.checked = u.endsWith, uh.checked = u.contains, Zf.style.display = Ge.checked ? "block" : "none", Xh());
    ...
    function Xh() {
        null === ka || Di || r || (Ba(u.left) ? ka.style.left = u.left + "px" : ka.style.left = Z.innerWidth / 2 - ka.offsetWidth / 2 + "px", Ba(u.top) ? ka.style.top = u.top + "px" : ka.style.top = Z.innerHeight / 2 - ka.offsetHeight / 2 + "px")
    }

    function kd() {
        var a = !1;
        null !==
        ka && "block" === ka.style.display && (ka.style.display = "none", Fe(), a = !0);
        return a
    }

    function Ei() {
        "block" === $b.style.display ? ($b.style.display = "none", Qd.className = "ib-square-hollow", Ra(Qd, b.restoreTooltipText)) : ($b.style.display = "block", Qd.className = "ib-minus", Ra(Qd, b.minimizedTooltipText))
    }
    ...
    function Fk() {
        if (0 === Db.length) {
            var a = "day-", b = mh.checked,
                d = nh.checked, e = d ? na.value : na.value.toLowerCase(), f = {}, k = vb(Bd()), h = k.length, g = Ma(),
                n = g === W, p = g === ra, l = g === da;
            g = g === ia;
            ...
            for (var q = 0; q < h; q++) {
                var r = k[q];
                if (ie(r)) {
                    var t = G(r.title), u = G(r.location), v = G(r.description), y = G(r.group), x = G(r.url), w = !1;
                    d || (t = t.toLowerCase(), v = v.toLowerCase(), u = u.toLowerCase(), y = y.toLowerCase(), x = x.toLowerCase());
                    $f.checked && ag(t, e) ? w = !0 : oh.checked && ag(u, e) ? w = !0 : ph.checked && ag(v, e) ? w = !0 : qh.checked && ag(y,
                        e) ? w = !0 : rh.checked && ag(x, e) && (w = !0);
                    b && (w = !w);
                    !w || null === Aa(a + r.id) && (n || p || l || g) || (n || p || l || g ? Db.push(te(r, !1)) : (t = r.from.getMonth() + "-" + r.from.getFullYear(), f.hasOwnProperty(t) || (Db.push(te(r, !1)), f[t] = !0)))
                }
            }
        } else Zc++;
        Ik();
    ...
    function Jk(a) {
        var b = "day-", d = Ma(), e = d === W, f = d === ra, k = d === da;
        d = d === ia;
        Gk(z, " focused-event");
        e ? b = "full-day-" : f ? b = "month-" : k ? b = "week-day-" : d && (b = "timeline-day-");
        b = Aa(b + a.id);
        if (null !== b && (b.className += " focused-event", Fi = a.id,
        e || f || k || d)) for (a = b.parentNode; ;) {
    ...
    function ag(a, b) {
        return sh.checked ? oa(a, b) : th.checked ? a.substring(a.length - b.length, a.length) === b : a.indexOf(b) > B.notFound
    }
    ...
    function Yf(a) {
        ...
        nd(Na.searchOptionsChanged, function () {
            var d = !0, e = u.history.length;
            if (a) {
                d = !1;
                for (var f = 0; f < e; f++) if (u.history[f] === c) {
                    d = !0;
                    break
                }
                d || u.history.push(c)
            }
            if (!a || d) u.lastSearchText = c, u.not = mh.checked, u.matchCase = nh.checked, u.showAdvanced = Ge.checked, u.searchTitle = $f.checked, u.searchLocation = oh.checked, u.searchDescription = ph.checked, u.searchGroup = qh.checked, u.searchUrl = rh.checked, u.startsWith = sh.checked, u.endsWith = th.checked, u.contains = uh.checked, Di && (u.left = ka.offsetLeft, u.top = ka.offsetTop), x(b.events.onSearchOptionsUpdated, u)
        }, 2E3, !1)
    }

    function Hk() {
        var a = u.history.length;
        0 < a ? (pb.style.display = "block", rd(Na.searchEventsHistoryDropDown), nd(Na.searchEventsHistoryDropDown, function () {
            var b = na.value, d = !1;
            if (Od(b) !== n.empty) {
                Kk();
                zb.innerHTML = n.empty;
                for (var e = 0; e < a; e++) {
                    var f = u.history[e], k = b;
                    f.substring(0, k.length).toLowerCase() === k.toLowerCase() && f.toLowerCase() !== b.toLowerCase() && (Lk(u.history[e], b.length), d = !0)
                }
            }
            d ? Mk() : af()
        }, 150, !1)) : pb.style.display = "none"
    }
    ...
    function af() {
        var a = !1;
        null !== zb &&
        "ib-arrow-up-full" === pb.className && (zb.style.display = "none", pb.className = "ib-arrow-down-full", a = !0);
        return a
    }

    function Mk() {
        null !== zb && "ib-arrow-down-full" === pb.className && (zb.style.display = "block", pb.className = "ib-arrow-up-full")
    }
    ...
    function Al() {
        if (!r && null === Eb) {
            ...
            Eb.appendChild(a);
            var c = ok(a);
            ve(c, b.displayTabText, function (a) {
                we(a, Rd, Eb)
            }, !0);
    ...
    function ie(a) {
        var c = G(a.group), d = c.toLowerCase();
        a = H(a.type);
        var e = !0;
        c !== n.empty ? p(O.visibleGroups) && (e =
            O.visibleGroups.indexOf(d) > B.notFound) : e = !b.hideEventsWithoutGroupAssigned;
    ...
    function ee() {
        if (Ma() !== ra && b.jumpToDateEnabled) {
            ...
            Hb();
            var a = Ma();
            null === a ? (x(b.events.onSetDate, bc), Bb(v, bc)) : a === W ? Bb(L, bc) : a === da ? Bb(Sb, bc) : a === Da ? Bb(new Date(sa, 0, 1), bc) : a === ia && Bb(ba, bc);
            eb.push(zh);
    ...
    function Ok() {
        var a =
            Ma(), c = Ae(bc);
        c.getFullYear() >= b.minimumYear && c.getFullYear() <= b.maximumYear && (null === a ? (F(c), rb()) : a === W ? Ua(c) : a === da ? zc(c) : a === Da ? Ac(c.getFullYear()) : a === ia && Jb(c), zh())
    }

    function cj() {
        null === T && (T = h("div", "calendar-tooltip"), ya.push(T), E.body.appendChild(T), Ni = h("div", "ib-close"), Ah = h("div", "ib-edit"), Bh = h("div", "title-buttons"), Bh.appendChild(Ni), Bh.appendChild(Ah), Sd = h("div", "title"), cg = h("div", "date"), Td = h("div", "duration"), dg = h("div", "repeats"), eg = h("div", "description"), fg = h("div", "location"),
            Ud = h("div", "url"), Ni.onclick = ic, Ah.onclick = function () {
            P(Dd)
    ...
    function ki(a, c, d, e) {
        ...
        if ("block" !== T.style.display && b.tooltipsEnabled) {
            ...
            nd(Na.showToolTip, function () {
                if (e || !E.body.contains(Ka) && !Mg() && !ek() && null === ca) {
                    d = p(d) ? d : n.empty;
                    T.className = d === n.empty ? "calendar-tooltip-event" : "calendar-tooltip";
                    if (R(d)) w(T, d); else if (Dd = c, T.innerHTML = n.empty, Sd.innerHTML = n.empty,
                        Td.innerHTML = n.empty, Ud.innerHTML = n.empty, !x(b.events.onToolTipEventRender, T, c)) {
                        T.onmousemove = C;
                        T.appendChild(Bh);
                        T.appendChild(Sd);
                        T.appendChild(cg);
                        ...
                        H(c.repeatEvery) > y.never && b.showReoccurringEventIcons && (f = h("div", "ib-refresh-medium ib-no-hover ib-no-active"), f.style.borderColor = Sd.style.color, Sd.appendChild(f));
                        Sd.innerHTML += kc(c.title);
                        Ba(c.repeatEvery) && c.repeatEvery > y.never ? (w(dg, b.repeatsText.replace(":", n.empty) + n.space + pd(c.repeatEvery)), Ub(T, dg)) : (dg.innerHTML = n.empty, gb(T, dg));
                        Ca(c.location) ? (w(fg, c.location), Ub(T, fg)) : (fg.innerHTML = n.empty, gb(T, fg));
                        Ca(c.description) ? (w(eg, c.description), Ub(T, eg)) : (eg.innerHTML = n.empty, gb(T, eg));
                        c.from.getDate() === c.to.getDate() ? c.isAllDay ? w(cg, b.allDayText) : (w(cg, de(c.from, c.to)), w(Td, Ob(c.from, c.to))) : (Xe(cg, c.from, c.to), w(Td, Ob(c.from, c.to)));
                        Td.innerHTML ===
                        n.empty && T.removeChild(Td)
                    }
                    vf(a, T)
                }
            }, f, !1)
    ...
    function Ra(a, b, d) {
        null !== a && (a.onmousemove = function (a) {
            ki(a, null, b, d)
        })
    }

    function Sa(a, c) {
        null !== fc && b.popUpNotificationsEnabled && (c = p(c) ? c : !0, rd(Na.hideNotification), fc.innerHTML = n.empty, c = h("div", c ? "success" : "error"), fc.appendChild(c), fc.style.display = "block", w(c, a), t(c, "ib-close-icon",
            b.closeTooltipText, Qk), nd(Na.hideNotification, function () {
            Qk()
        }, 5E3, !1))
    }
    ...
    function Lh(a, c) {
        if (null !== a) {
            ...
            a.innerHTML = n.empty;
            b.startOfWeekDay === va.saturday || b.startOfWeekDay === va.sunday ? (Pi(a, b.startOfWeekDay, d), Pi(a, 0, b.startOfWeekDay)) : Pi(a, 0, d);
    ...
    function Km(a, c) {
        var d = b.dayHeaderNames[c], e = h("div", Fg());
        w(e,
            d);
        a.appendChild(e);
    ...
    function kf(a, b) {
        Xa(a) && b ? (Qi(a, !1), ob.push(a), Ie++, a.style.zIndex = Ie) : Ma() === a || Xa(a) || (Qi(a, !1), ob.push(a), Ie++, a.className += " view-shown", a.style.zIndex = Ie, kd(), rf())
    }
    ...
    function rf(a) {
        a = p(a) ? a : !0;
        var c = Ma(), d = null;
        null === c ? d = tb.fullMonth : c === W ? d = tb.fullDay : c === da ? d = tb.fullWeek : c === Da ? d = tb.fullYear : c === ia ? d = tb.timeline : c === ra && (d = tb.allEvents);
    ...
    function Nj(a, c, d, e, f) {
        var k = c.offsetHeight, h = c.offsetHeight / 1440;
        c = 0;
        var g = null;
        if (!f.isAllDay) {
            g = H(f.repeatEvery);
        ...
        e.offsetTop + e.offsetHeight > k - b.spacing ? (d = k - e.offsetTop - 3 * b.spacing + "px", e.style.height = d, e.style.maxHeight = d) : e.style.maxHeight = k - (e.offsetTop + 2 * b.spacing) - h + "px";
    ...
    function um(a, c, d, e) {
        ...
        d.offsetLeft + d.offsetWidth > f - b.spacing ? (f = f - d.offsetLeft - 4 * b.spacing + "px", d.style.width = f, d.style.maxWidth = f) : d.style.maxWidth = f - (d.offsetLeft + 2 * b.spacing) - k + "px";
        return a - b.spacing
    }

    function Qj(a, b, d, e, f) {
        var c = 0;
        null !== d && (dc(a) && Xa(b) && f ? (a = e.offsetHeight / 1440 * gg(new Date), d.style.display = "block", d.style.top =
            a - d.offsetHeight / 2 + "px", c = a) : d.style.display = "none");
        return c
    }
    ...
    function Rj(a) {
        ...
        if (1 < c) {
            a.sort(Lm);
            for (var d = 0; d < c; d++) for (var e = a[d], f = 0; f < c; f++) if (f !== d) {
                var k = a[f], h = !0, g = e.offsetLeft, p = e.offsetTop, l = e.offsetWidth, q = k.offsetLeft,
                    r = k.offsetTop, t = k.offsetHeight, u = k.offsetWidth;
                if (p + e.offsetHeight < r || p > r + t || g + l < q || g > q + u) h =
                    !1;
                h && (h = G(e.getAttribute("event-position")), g = G(k.getAttribute("event-position")), h === n.empty && g === n.empty ? (Ch(e), Ch(k), k.style.left = e.offsetLeft + e.offsetWidth + b.spacing + "px", e.setAttribute("event-position", "left"), k.setAttribute("event-position", "right")) : h === n.empty && "right" === g ? (Ch(e), e.setAttribute("event-position", "left"), k.setAttribute("event-position", "right")) : h === n.empty && "left" === g && (e.style.left = k.offsetLeft + k.offsetWidth + b.spacing + "px", Ch(e), e.setAttribute("event-position", "right"), k.setAttribute("event-position",
                    "left")))
            }
        }
    }
    ...
    function Kj(a, c, d) {
        C(a);
        null === yg ? 0 === a.dataTransfer.files.length ? Rk(a, c.getFullYear(), c.getMonth(), c.getDate()) : Sk(a) : (U(Bg, c) || (ca = Qb, Vd = Bg, Tk(a, c.getFullYear(), c.getMonth(), c.getDate())), c = d.offsetHeight / 1440, d = Ze(d), a = (la.abs(a.pageY) - d.top + Ag - zg) / c, Qb.from = fb(Qb.from, a), Qb.to = fb(Qb.to, a), jb(), x(b.events.onEventUpdated,
            Qb), Sa(b.eventUpdatedText.replace("{0}", Qb.title)), ma(), Qb = yg = null, zg = Ag = 0)
    }
        ...
        if (b.manualEditingEnabled) {
            ...
            if (null !== c && 0 < d) {
                ...
                for (var e = !1, f = 0; f < d; f++) {
                    var k = a[f];
                    k.height !== k.eventElement.offsetHeight && (e = (k.eventElement.offsetHeight - k.height) / c, k.height = k.eventElement.offsetHeight, k.eventDetails.to = fb(k.eventDetails.to, e), e = !0, x(b.events.onEventUpdated, k.eventDetails), Sa(b.eventUpdatedText.replace("{0}",
                        k.eventDetails.title)))
                }
                e && (jb(), ma())
            }
        }
    ...
    function Uk() {
        sd && b.fullScreenModeEnabled && (sd = !1, z.className = z.className.replace(" full-screen-view", n.empty), z.style.cssText = Xk, Yk("ib-arrow-expand-left-right", b.enableFullScreenTooltipText), ma(), x(b.events.onFullScreenModeChanged, !1))
    }
    ...
    function Wk() {
        ...
        Yk("ib-arrow-contract-left-right",
            b.disableFullScreenTooltipText);
        ma()
    }
    ...
    function fm(a, c, d) {
        if (b.showHolidays) for (var e = [], f = b.holidays.length, k = 0; k < f; k++) {
            var h = b.holidays[k], g = G(h.title, n.empty), p = G(h.backgroundColor, n.empty),
                l = G(h.textColor, n.empty);
            Pj(h, a) && g !== n.empty && e.indexOf(g.toLowerCase()) ? (Mm(h, d, g, c), p !== n.empty && d.style.setProperty("background-color", p, "important"), l !== n.empty && d.style.setProperty("color",
                l, "important"), e.push(g.toLowerCase())) : (d.style.removeProperty("background-color"), d.style.removeProperty("color"))
        }
    }

    function Mm(a, c, d, e) {
        var f = Yc(a.onClick) || R(a.onClickUrl) ? "holiday-link" : "holiday", k = a.onClick;
        R(a.onClickUrl) && (k = function () {
    ...
    function Pj(a, b) {
        var c = H(a.day), e = H(a.month);
        a = H(a.year);
        var f = !1;
        0 === a && c === b.getDate() && e === b.getMonth() + 1 ? f = !0 : 0 < a && c === b.getDate() && e === b.getMonth() + 1 && a === b.getFullYear() && (f = !0);
        return f
    }
    ...
    function xb(a) {
        for (var b in qb) if (qb.hasOwnProperty(b)) for (var d in qb[b]) if (qb[b].hasOwnProperty(d)) {
            var e = Zk(qb[b][d]);
            if (a(e, b, d)) return
        }
    }
    ...
    function ak(a, c) {
        ...
        If(b.confirmEventsRemoveTitle, b.confirmEventsRemoveMessage, function () {
            var e = 0;
            d();
            xb(function (b) {
                H(b.repeatEvery) ===
                y.never && c(b.from, a) && (q.removeEvent(b.id, !1), e++)
            });
            jb();
    ...
    function sk(a) {
        ...
        p(N[a].eventEditorInput) && (N[a].eventEditorInput.checked =
            !0)
    }

    function Dm() {
        var a = 0, b;
        for (b in N) if (N.hasOwnProperty(b) && p(N[b].eventEditorInput) && N[b].eventEditorInput.checked) {
            a = parseInt(b);
            break
        }
        return a
    ...
    function dc(a) {
        var b = new Date;
        return null !== a && a.getDate() === b.getDate() && a.getFullYear() === b.getFullYear() && a.getMonth() === b.getMonth()
    }
    ...
    function vd(a) {
        var b = ("0" + a.getDate()).slice(-2), d = ("0" + a.getMonth()).slice(-2);
    ...
    function Kg(a) {
        var c = b.thText;
        if (31 === a || 21 === a || 1 === a) c = b.stText; else if (22 === a || 2 === a) c = b.ndText; else if (23 === a || 3 === a) c = b.rdText;
        return c
    }
    ...
    function Ae(a, b) {
        ...
        if (a.value !== n.empty) if ("date" === a.type) b = new Date(a.value + "T00:00:00Z"); else if (a = a.value.match(/^(\d{1,2})\/(\d{1,2})\/(\d{4})$/)) a = new Date(a[3], a[2] - 1, a[1], 0, 0, 0, 0), a instanceof Date && !isNaN(a) && (b = a);
    ...
    function hh(a, b) {
        var c = 0, e = 0, f = b.split(":");
        2 === f.length && (b = parseInt(f[0]), f = parseInt(f[1]), !isNaN(b) && 2 >= b.toString().length && (c = b), !isNaN(f) && 2 >= f.toString().length && (e = f));
        a.setHours(c);
        a.setMinutes(e)
    }
    ...
    function Pe(a) {
        if (b.startOfWeekDay ===
            va.saturday || b.startOfWeekDay === va.sunday) a += 7 - b.startOfWeekDay;
        return a
    }
    ...
    function Nb(a, c, d, e, f) {
        ...
        b.showDayNumberOrdinals && (c = Kg(c.getDate()), p(c) && (d = h("sup"), d.innerText = c, a.appendChild(d)));
        p(e) && aa(a, e)
    }
    ...
    function di(a, c, d, e) {
        if (!nf(c) && b.dragAndDropForEventsEnabled && b.manualEditingEnabled) {
            ...
            a.ondragend = function () {
                ...
                ca = Vd = null;
                p(e) && (e.className = e.className.replace(k, n.empty), Gg(e, f.getFullYear(), f.getMonth(), f.getDate()));
                Dh("cell", function (a) {
    ...
    function bl(a, b, d) {
        C(a);
        null !== ca && b.className.indexOf(" drag-over") > B.notFound && !U(Vd, d) &&
        (b.className = b.className.replace(" drag-over", n.empty))
    }

    function Tk(a, c, d, e) {
        var f = new Date(c, d, e);
        if (null === ca || U(Vd, f)) null === ca && Rk(a, c, d, e); else {
            ...
            p(d) && (e = Pc(f, ca.from), f > ca.from ? d.setDate(d.getDate() +
                e) : d.setDate(d.getDate() - e));
    ...
    function Rk(a, c, d, e) {
        ...
        if (p(a) && null === ca) {
            var f = new Date(a.from), k = new Date(a.to);
    ...
    function Hd(a, c, d) {
        b.dialogMovingEnabled && (a.onmousedown = function (a) {
            Wd || (Ga(), Fb = c, Wd = !0, cl = a.pageX - Fb.offsetLeft, dl = a.pageY - Fb.offsetTop, Eh = Fb.offsetLeft, Fh = Fb.offsetTop)
    ...
    function Ol(a) {
        Wd && (Fb.style.left = a.pageX - cl + "px",
            Fb.style.top = a.pageY - dl + "px")
    }
    ...
    function we(a, b, d) {
        var c = d.getElementsByClassName("tab-control-selected"), f = c.length;
    ...
    function be(a, b, d, e) {
        ...
        e && p(d) && d < v && (d.getFullYear() !== v.getFullYear() || d.getMonth() !== v.getMonth()) && (a.className += " not-in-current-month");
        Ca(b.color) ? (a.style.backgroundColor = b.color, Ca(b.colorText) && (a.style.color = b.colorText), Ca(b.colorBorder) && (a.style.borderColor = b.colorBorder)) : b.isAllDay && (a.className += " all-day")
    }

    function hf(a, b) {
        Fi === b.id && (a.className += " focused-event");
        fl(b.id) && (a.className += " selected-event");
        for (var c = !1, e = ja.length, f = 0; f < e; f++) if (ja[f].id === b.id) {
            c = !0;
            break
        }
    ...
    function hg(a, b, d) {
        ...
        for (var f = c.length, k = 0; k < f; k++) {
            var h = c[k], g = h.getAttribute("event-id");
            null !== g && g === a.toString() && (h.className = d ? h.className.replace(n.space + b, n.empty) : h.className + (n.space + b))
        }
    }
    ...
    function gm(a, b) {
        if (dc(a) && !r) {
            a = new Date;
            var c = new Date, e = new Date, f = H(b.repeatEvery);
            ...
            Ba(b.alertOffset) && 0 < b.alertOffset && (a =
                fb(a, -b.alertOffset));
            if (e >= a && e <= c) {
                if (!ib(b.showAsBusy) || b.showAsBusy) pe = !0;
                (!gl.hasOwnProperty(b.id) && !ib(b.showAlerts) || b.showAlerts) && hl(function () {
                    Om(b)
                }, !1, b)
            }
        }
    ...
    function hl(a,
                c, d) {
        b.eventNotificationsEnabled && !r && (c = p(c) ? c : !0, Notification ? a() : c && console.error("Browser notifications API unavailable."), p(d) && x(b.events.onNotification, d))
    }
    ...
    function gk(a) {
        ja = [];
        var b = Ea.length;
        if (0 < b) for (a = 0; a < b; a++) ja.push(Ea[a]); else ja.push(a)
    }

    function fl(a) {
        for (var b = !1, d = Ea.length, e = 0; e < d; e++) if (Ea[e].id ===
            a) {
            b = !0;
            break
        }
    ...
    function jf(a, b) {
        ...
        Ga();
        if (nf(b)) fa(a) ||
        mc(); else if (fa(a)) if (fl(b.id)) {
            a = Ea.length;
            for (var c = 0; c < a; c++) if (Ea[c].id === b.id) {
                Ea.splice(c, 1);
                break
            }
            hg(b.id, "selected-event", !0)
        } else Ea.push(b), hg(b.id, "selected-event", !1); else mc()
    }
    ...
    function Sh() {
        0 < b.autoRefreshTimerDelay && !r && bg && nd(Na.autoRefresh, function () {
            ej();
            La()
    ...
    function ej() {
        ...
        if (pa(a)) for (var c = a.length, d = 0; d < c; d++) {
            var e = a[d];
    ...
    function La(a, c) {
        if (b.isWidget) mg ? F() : F(v); else if (a = p(a) ? a : !1, c = p(c) ? c : !1, oj() || a) ma(), mg ? (F(), Xj()) : Ha(), c && x(b.events.onRefresh)
    }
    ...
    function nd(a, b, d, e) {
        e = p(e) ? e : !0;
        Oi(a) || (Gb[a] = e ? setInterval(b, d) : setTimeout(function () {
            b();
            delete Gb[a]
        }, d))
    }
    ...
    function h(a, b, d, e) {
        ...
        c = Si[c].cloneNode(!1);
        if ("input" === a && "button" !== d || "textarea" === a) p(e) ?
            c.id = e : c.id = ec();
        p(b) && (c.className = b);
        p(d) && (c.type = d);
        return c
    ...
    function Aa(a) {
        Ke.hasOwnProperty(a) && null !== Ke[a] || (Ke[a] =
            il(a));
    ...
    function il(a) {
        var b = null;
        if (null === z) b = E.getElementById(a); else for (var d = z.getElementsByTagName("*"), e = d.length, f = 0; f < e; f++) if (d[f].id === a) {
            b = d[f];
            break
        }
        return b
    ...
    function kc(a) {
        var c = a;
        b.allowHtmlInDisplay || (c = h("div"), c.innerHTML = a, c =
            c.innerText);
        return c
    }
    ...
    function bd(a, b, d) {
        d = p(d) ? d : !0;
        var c = null;
        Z.getComputedStyle ? c = E.defaultView.getComputedStyle(a, null).getPropertyValue(b) : a.currentStyle && (c = a.currentStyle[b]);
        d && (c = parseFloat(c, 10));
        return c
    }
    ...
    function Dh(a, b, d) {
        ...
        for (var c = a.length, f = 0; f < c; f++) for (var k = a[f].children, h = k.length, g = 0; g < h; g++) k[g] !== d && b(k[g])
    }

    function ld(a) {
        for (var b =
            a.children, d = b.length - 1; d--;) a.appendChild(b[d])
    }
    ...
    function sm(a, c) {
        ...
        b.manualEditingEnabled && (d.appendChild(h("div")), aa(d, b.clickText + n.space), aa(d, b.hereText, "link", c), aa(d, n.space + b.toAddANewEventText))
    }
    ...
    function Cg(a, b) {
        var c = a;
        b = p(b) ? b : 30;
        a.length > b && (b = 0 === b % 2 ? b / 2 : (b - 1) / 2, c = a.substring(0, b) + "..." + a.substring(a.length - b));
        return c
    }
    ...
    function ae(a, b) {
        var c = pa(a) && pa(b);
        c && (a.sort(), b.sort(), c = cc.stringify(a) ===
            cc.stringify(b));
        return c
    }
    ...
    function jb() {
        if (b.useLocalStorageForEvents && Z.localStorage) {
            if (b.useLocalStorageForEvents && Z.localStorage) {
                for (var a = Z.localStorage.length, c = [], d = 0; d < a; d++) oa(Z.localStorage.key(d), "CJS_") && c.push(Z.localStorage.key(d));
                a = c.length;
    ...
    function Ri(a) {
        for (var b = a.length, d = [], e = [], f = function (a, c) {
            d.push(a);
            e = e.concat(c);
            d.length === b && jl(e)
        }, k = 0; k < b; k++) {
            var h = a[k], g = h.name.split(".").pop().toLowerCase();
            "json" === g ? Pm(h, f) : ("ics" === g || "ical" === g) && Qm(h, f)
        }
    }

    function Pm(a, b) {
        var c = new FileReader, e = [];
        c.readAsText(a);
    ...
    function kl(a, b) {
        ...
        var c = a.length;
        if (a[0].indexOf("BEGIN:VCALENDAR") > B.notFound && a[c - 1].indexOf("END:VCALENDAR") > B.notFound) for (var e = !1, f = {}, h = 0; h < c; h++) {
            var g = a[h];
            if (g.indexOf("BEGIN:VEVENT") >
                B.notFound) e = !0; else if (g.indexOf("END:VEVENT") > B.notFound) {
            ...
            if (e) if (oa(g, "UID:")) f.id = g.split(":").pop(); else if (oa(g, "SUMMARY:")) f.title = g.split(":").pop(); else if (oa(g, "DESCRIPTION:")) f.description = g.split(":").pop(); else if (oa(g, "DTSTART:") || oa(g, "DTSTART;")) f.from = Gh(g.split(":").pop()), f.isAllDay = 8 === g.split(":").pop().length; else if (oa(g, "DTEND:") || oa(g, "DTEND;")) f.to = Gh(g.split(":").pop(),
                !0); else if (oa(g, "CREATED:")) f.created = Gh(g.split(":").pop()); else if (oa(g, "LOCATION:")) f.location = g.split(":").pop(); else if (oa(g, "URL:")) f.url = g.split(":").pop(); else if (oa(g, "TRANSP:")) f.showAsBusy = "OPAQUE" === g.split(":").pop(); else if (oa(g, "BEGIN:VALARM")) f.showAlerts = !0; else if (oa(g, "CATEGORIES:")) f.group = g.split(":").pop(); else if (oa(g, "ORGANIZER;")) l = f, g = g.split(";").pop().split(":"), l.organizerName = g[0].replace("CN=", n.empty), l.organizerEmailAddress = g[2]; else if (oa(g, "RRULE:")) {
                l = f;
                g = g.split(":").pop().split(";");
                for (var r = g.length, t = null, u = null, v = null, x = 0; x < r; x++) {
                    var w = g[x];
                    oa(w, "FREQ=") ? t = w.split("=")[1] : oa(w, "INTERVAL=") ? u = w.split("=")[1] : oa(w, "UNTIL=") && (v = w.split("=")[1])
                }
                p(t) && (p(u) && (u = parseInt(u), 2 <= u && "WEEKLY" !== t && (l.repeatEveryCustomValue = u)), p(l.repeatEveryCustomValue) ? "DAILY" === t ? l.repeatEveryCustomType = M.daily : "WEEKLY" === t ? l.repeatEveryCustomType = M.weekly : "MONTHLY" === t ? l.repeatEveryCustomType = M.monthly : "YEARLY" === t && (l.repeatEveryCustomType = M.yearly) : "DAILY" === t ? l.repeatEvery = y.everyDay : "WEEKLY" ===
                t ? l.repeatEvery = y.everyWeek : "MONTHLY" === t ? l.repeatEvery = y.everyMonth : "MONTHLY" === t && 2 === u ? l.repeatEvery = y.every2Weeks : "YEARLY" === t && (l.repeatEvery = y.everyYear), p(v) && (g = Gh(v), g.setDate(g.getDate() - 1), l.repeatEnds = g))
            }
        }
    }

    function Gh(a, b) {
        var c = n.empty, e = 8 === a.length;
        c += a.substring(0, 4);
        a = a.slice(4);
        c += "-" + a.substring(0, 2);
        a = a.slice(2);
        ...
        a = a.slice(2);
        c += "T";
        e ? (b = p(b) ? b : !1, c += b ? "23:59:00" : "00:00:00") : (a = a.slice(1), c += a.substring(0, 2), a = a.slice(2), c += ":" + a.substring(0, 2), a = a.slice(2),
            c += ":" + a.substring(0, 2), a.slice(2));
        return new Date(c + "Z")
    }
    ...
    function jl(a) {
        0 < a.length && (jb(), Mb(), Ha(), ma(), Sa(b.eventsImportedText.replace("{0}", a.length)), x(b.events.onEventsImported, a))
    }

    function vc(a, c, d, e) {
        c = p(c) ? c.toLowerCase() : "csv";
        e = p(e) ? e : !1;
        var f = n.empty, g = vb, m = [];
        m = p(a) ? m.concat(a) : Bd();
        m = vb(m);
        a = g(m, !1);
        if ("csv" === c) {
            ...
            f.push("</Events>");
            f = f.join(n.newLine)
        } else if ("json" === c) f = hk(a); else if ("text" === c) {
            m = d;
            f = [];
            g = a.length;
            ...
            for (m = 0; m < g; m++) {
                ...
                r = Hh(l);
                t = r.length;
                for (u = 0; u < t; u++) v = r[u], "customTags" !== v && l.hasOwnProperty(v) && null !== l[v] && f.push(Xi(v) + ": " + Ih(v, l[v]));
                f.push(n.empty)
            }
            f.pop();
            f = f.join(n.newLine)
            ...
            for (m = 0; m < g; m++) {
                ...
                l.isAllDay ?
                    (f.push("DTSTART:" + ml(l.from)), f.push("DTEND:" + ml(l.to))) : (f.push("DTSTART:" + Le(l.from)), f.push("DTEND:" + Le(l.to)));
                ...
                if (!ib(l.showAlerts) || l.showAlerts) f.push("BEGIN:VALARM"), f.push("TRIGGER;VALUE=DATE-TIME:" + Le(l.from)), f.push("ACTION:DISPLAY"), f.push("END:VALARM");
                f.push("END:VEVENT")
            }
            ...
            for (m = 0; m < g; m++) {
                ...
                f.push("<ul>");
                for (u = 0; u < t; u++) v = r[u], "customTags" !== v && l.hasOwnProperty(v) && null !== l[v] && f.push("<li><b>" + Xi(v) + "</b>: " + Ih(v,
                    l[v]) + "</li>");
                f.push("</ul>")
            }
            f.push("</body>");
        ...
        f !== n.empty && (e ? (Jf.clipboard.writeText(f), Sa(b.eventsExportedText)) : (e = h("a"), g = "text", l = m = c, "text" === c ? (m = "plain", l = "txt") : "ical" === c ? (m = "calendar", l = "ics") : "json" === c ? g = "application" :
            "md" === c ? m = "x-markdown" : "html" === c ? m = "html" : "tsv" === c && (m = "tab-separated-values"), m = [g, m, l], c = m[0], g = m[1], m = m[2], d = p(d) ? d : ik(m), e.style.display = "none", e.setAttribute("target", "_blank"), e.setAttribute("href", "data:" + c + "/" + g + ";charset=utf-8," + encodeURIComponent(f)), e.setAttribute("download", d), E.body.appendChild(e), e.click(), E.body.removeChild(e), Sa(b.eventsExportedToText.replace("{0}", d))), x(b.events.onEventsExported, a))
    }

    function ik(a, c) {
        c = p(c) ? c : b.exportStartFilename;
        var d = new Date, e = J(d.getDate()) +
            "-" + J(d.getMonth() + 1) + "-" + d.getFullYear();
    ...
    function Me(a) {
        ...
        p(a) && (c = J(a.getDate()) + "/" + J(a.getMonth() + 1) + "/" + a.getFullYear(), a = J(a.getHours()) + ":" + J(a.getMinutes()), c = c + n.space + a);
        return c
    }
    ...
    function pd(a) {
        var c = b.dailyText;
        a = H(a);
        a === y.everyDay ? c = b.repeatsEveryDayText : a === y.everyWeek ? c = b.repeatsEveryWeekText : a === y.every2Weeks ? c = b.repeatsEvery2WeeksText : a === y.everyMonth ? c = b.repeatsEveryMonthText : a === y.everyYear ? c = b.repeatsEveryYearText : a === y.custom && (c = b.repeatsByCustomSettingsText);
        return c
    }
    ...
    function Ih(a, c, d) {
        ...
        "boolean" === typeof c ? e = d ? c.toString() : kg(c) : "object" === typeof c && c instanceof Date ? e = d ? '"' + c.toISOString() + '"' : Me(c) : "object" === typeof c && c instanceof Array ? e = "repeatEveryExcludeDays" !== a || d ? d ? "[" + Jh(c) + "]" : Jh(c) : ol(c) : "number" === typeof c && ("repeatEvery" !== a || d ? "repeatEveryCustomType" !== a || d ? e = "type" !== a || d ? c.toString() : N[parseInt(c)].text : (a = b.dailyText, c = H(c), c === M.daily ? a = b.dailyText : c === M.weekly ? a = b.weeklyText : c === M.monthly ? a =
            b.monthlyText : c === M.yearly && (a = b.yearlyText), e = a) : e = pd(c));
        return e
    }

    function ol(a) {
        var c = [];
        if (pa(a)) for (var d = a.length, e = 0; e < d; e++) {
            var f = a[e] - 1;
            -1 === f && (f = 6);
            c.push(b.dayNames[f])
        }
    ...
    function Ui() {
        var a = [b.idText, b.typeText, b.fromText, b.toText, b.isAllDayText, b.titleText, b.descriptionText, b.locationText, b.backgroundColorText, b.textColorText, b.borderColorText, b.repeatsText, b.repeatEndsText, b.repeatDaysToExcludeText, b.seriesIgnoreDatesText, b.createdText, b.lastUpdatedText, b.organizerNameText,
            b.organizerEmailAddressText, b.urlText, b.lockedText, b.showAlertsText, b.showAsBusyText, b.alertOffsetText];
        return [a, a.length]
    }
    ...
    function Wi() {
        var a = new Date, b = Ph("{ddd}, {dd} {mmm} {yyyy}", a);
    ...
    function hk(a) {
        ...
        b.push('"events": [');
        for (var e = 0; e < d; e++) {
            var f = a[e], g = Hh(f), h = g.length;
            b.push("{");
            for (var l = 0; l < h; l++) {
                var p = g[l];
                "customTags" !== p && f.hasOwnProperty(p) && null !== f[p] && b.push('"' + p + '":' + Ih(p, f[p], !0) + ",")
            }
            f = b[b.length - 1];
    ...
    function Le(a) {
        var b = [];
        p(a) && (b.push(a.getFullYear()), b.push(J(a.getMonth() + 1)), b.push(J(a.getDate())), b.push("T"), b.push(J(a.getHours())), b.push(J(a.getMinutes())), b.push("00Z"));
    ...
    function Rm(a, b) {
        ...
        if (b === y.custom) {
            ...
            b === M.daily ?
                c.push("FREQ=DAILY") : b === M.weekly ? c.push("FREQ=WEEKLY") : b === M.monthly ? c.push("FREQ=MONTHLY") : b === M.yearly && c.push("FREQ=YEARLY");
            c.push("INTERVAL=" + e.toString())
        } else b === y.everyDay ? c.push("FREQ=DAILY") : b === y.everyWeek || b === y.every2Weeks ? c.push("FREQ=WEEKLY") : b === y.everyMonth ? c.push("FREQ=MONTHLY") : b === y.everyYear && c.push("FREQ=YEARLY"), b === y.every2Weeks ? c.push("INTERVAL=2") : c.push("INTERVAL=1");
    ...
    function x(a) {
        var b = null, d = [].slice.call(arguments, 1);
        0 < d.length && (b = !1);
    ...
    function ce(a, c, d) {
        Yc(b.events.onEventClick) && a.addEventListener("click", function () {
            x(b.events.onEventClick, c)
        });
        b.manualEditingEnabled ? a.ondblclick = function (a) {
            C(a);
            p(d) ? P(c, null, null, d) : P(c)
        } : Yc(b.events.onEventDoubleClick) && (a.ondblclick = function () {
    ...
    function bf(a) {
        p(a) && C(a);
        if (!r || db) a = new Date(v), a.setMonth(a.getMonth() -
            1), a.getFullYear() >= b.minimumYear && (F(a), x(b.events.onPreviousMonth, a), rb())
    }

    function cf(a) {
        p(a) && C(a);
        if (!r || db) a = new Date(v), a.setMonth(a.getMonth() + 1), a.getFullYear() <= b.maximumYear && (F(a), x(b.events.onNextMonth, a), rb())
    }
    ...
    function ug() {
        if (!r || db) {
            var a = new Date(v);
            a.setFullYear(a.getFullYear() + 1);
            a.getFullYear() <= b.maximumYear && (F(a), x(b.events.onNextYear,
                a), rb())
        }
    }
    ...
    function pl(a) {
        ...
        b.fullScreenModeEnabled = l(b.fullScreenModeEnabled,
            !0);
        ...
        b.urlWindowTarget = cb(b.urlWindowTarget,
            "_blank");
        ...
        b.allowHtmlInDisplay = l(b.allowHtmlInDisplay,
            !1);
        ...
        b.useLocalStorageForEvents =
            l(b.useLocalStorageForEvents, !1);
        ...
        b.sideMenu.showGroups = l(b.sideMenu.showGroups,
            !0);
        ...
        b.views.fullDay.minutesBetweenSections = ta(b.views.fullDay.minutesBetweenSections,
            30);
        ...
        b.views.fullWeek.minutesBetweenSections =
            ta(b.views.fullWeek.minutesBetweenSections, 30);
        ...
        b.views.fullWeek.showEventUrls = l(b.views.fullWeek.showEventUrls,
            !1);
        ...
        b.views.fullMonth.applyCssToEventsNotInCurrentMonth =
            l(b.views.fullMonth.applyCssToEventsNotInCurrentMonth, !0);
        ...
        b.views.fullMonth.showMonthButtonsInYearDropDownMenu =
            l(b.views.fullMonth.showMonthButtonsInYearDropDownMenu, !0);
        ...
        (b.views.fullMonth.allowEventScrolling = !1, b.views.fullMonth.allowEventScrolling && (b.views.fullMonth.maximumEventsPerDayDisplay = 0));
        ...
        b.views.timeline.defaultAxis =
            cb(b.views.timeline.defaultAxis, "group");
        ...
        b.events.onToday = D(b.events.onToday,
            null);
        ...
        b.events.onEventsUpdated =
            D(b.events.onEventsUpdated, null);
        ...
        b.events.onDatePickerDateChanged = D(b.events.onDatePickerDateChanged,
            null);
        ...
        b.events.onBusyStateChange = D(b.events.onBusyStateChange,
            null);
        ...
        b.events.onWidgetEventRender =
            D(b.events.onWidgetEventRender, null);
        ...
        $c(b.monthNames, 12) && (b.monthNames = "January February March April May June July August September October November December".split(" "));
        $c(b.monthNamesAbbreviated, 12) && (b.monthNamesAbbreviated = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "));
        b.previousMonthTooltipText = g(b.previousMonthTooltipText,
            "Previous Month");
        ...
        b.toSmallerThanFromErrorMessage = g(b.toSmallerThanFromErrorMessage, "Please select a 'To' date that is larger than the 'From' date.");
        ...
        b.confirmEventRemoveMessage = g(b.confirmEventRemoveMessage, "Removing this event cannot be undone.  Do you want to continue?");
        ...
        b.seriesIgnoreDatesText = g(b.seriesIgnoreDatesText,
            "Series Ignore Dates:");
        ...
        b.enableFullScreenTooltipText = g(b.enableFullScreenTooltipText,
        ...
        b.confirmEventsRemoveMessage = g(b.confirmEventsRemoveMessage, "Removing these non-repeating events cannot be undone.  Do you want to continue?");
        ...
        b.showHolidaysInTheDisplaysText = g(b.showHolidaysInTheDisplaysText, "Show holidays in the main display and title bars");
        ...
        b.showMenuTooltipText = g(b.showMenuTooltipText,
            "Show Menu");
        ...
        b.eventsExportedToText =
            g(b.eventsExportedToText, "Events exported to {0}.");
        ...
        b.selectNoneText = g(b.selectNoneText,
            "Select None");
        ...
        b.confirmEventUpdateMessage = g(b.confirmEventUpdateMessage, "Would you like to update the event from this point forward, or the entire series?");
        ...
        b.previousPropertyTooltipText =
            g(b.previousPropertyTooltipText, "Previous Property");
    ...
    var q =
            this, E = null, Z = null, Jf = null, za = null, la = null, cc = null,
        n = {empty: "", space: " ", newLine: "\n", newLineCharacterReturn: "\r\n"}, B = {notFound: -1},
        va = {monday: 0, saturday: 5, sunday: 6}, Q = {
            enter: 13,
            escape: 27,
            left: 37,
            right: 39,
        ...
        M = {daily: 0, weekly: 1, monthly: 2, yearly: 3}, Re = {day: 0, previousMonthDay: 1, nextMonthDay: 2}, b = {},
        u = {}, N = {
        ...
        }, O = {visibleGroups: null, visibleEventTypes: null, visibleAllEventsMonths: {}}, lb = !1, Zd = !1, Oe = !1,
        qb = {}, Cd = {}, Ea = [], ja = [], Pb = !1, Vd = null, ca = null, gl = {}, v = null, mg = !1, Mc = null,
        pe = !1, Yj = !1, Ke = {}, ya = [], Si = {}, Gb = {}, bg = !0, Na = {
        ...
        }, ub = null, Kb = null, pg = !1, cd = null, Cc = null, Gc = null, gd = null, Hc = null, fd = null, jd = null,
        Dc = null, id = null, Ec = null, hd = null, Fc = null, $d = null, Lc = null, Ye = null, r = !1, db = !1,
        lj = null, tb = {
        ...
        }, ob = [], Ie = 0, yg = null, zg = null, Qb = null, Ag = null, Bg = null, z = null, Ka = null, sd = !1, Xk = null,
        od = [], W =
            null, df = null, wb = null, Nc = null, wa = null, he = null, L = null, gc = [], $h = null, Hj = null, ff = null,
        Ij = null, Dg = [], da = null, Qa = null, bi = null, Tj = null, zd = null, yd = null, Ad = null, me = null,
        le = null, lf = null, hc = [], mf = {}, Sb = null, Sj = null, ne = null, ei = !1, Hg = null, of = 0, fi = [],
        Ib = null, pf = [], S = null, oe = null, Oh = null, Lg = null, Tb = null, qf = null, Rc = {}, Jg = null,
        Ig = null, mb = null, Qc = 0, gi = null, yc = null, ed = [], Nh = null, Da = null, mi = null, li = null,
        qe = null, sa = null, Og = 0, ra = null, oi = null, Zj = null, Ed = null, Lb = [], vg = [], pi = [], ia = null,
        qi = null, ck = null, bk = null, Ja = null, Fd =
            null, sf = null, tf = null, Qg = {}, uf = [], Bc = [], ba = null, Pg = null, Za = null,
        re = "location organizerName group organizerEmailAddress url title description".split(" "), eb = [], Fb = null,
        Eh = 0, Fh = 0, Wd = !1, cl = 0, dl = 0, bb = null, Vb = null, Yg = null, Zg = null, Uc = null, Xg = null,
        Sc = null, Wb = null, Xb = null, hb = null, Yb = null, ye = null, Kf = null, Lf = null, Ab = null, wi = null,
        Ld = null, Md = null, Kd = null, ze = null, qc = null, Mf = null, Nf = null, Of = null, Pf = null, Qf = null,
        Zb = null, $g = null, Id = null, Rf = null, Sf = null, Tf = null, Wc = null, ea = {}, Gf = null, Ug = null,
        Jd = null, yi = null, Uf = null,
        rc = null, Be = null, Ce = null, De = null, sc = null, ah = null, bh = null, ch = null, dh = null, eh = null,
        fh = null, gh = null, Nd = null, Xc = null, zi = null, Ai = null, Vg = null, Bi = null, Xf = null, tc = null,
        Ta = null, Ci = null, xk = null, yk = null, zk = null, Ak = null, Bk = null, Ck = null, Dk = null, uc = null,
        Cb = null, lh = null, ka = null, Qd = null, $b = null, na = null, nh = null, mh = null, Ge = null, Zf = null,
        $f = null, oh = null, ph = null, qh = null, rh = null, sh = null, th = null, uh = null, vh = null, wh = null,
        Di = !1, Db = [], Zc = 0, Fi = null, zb = null, pb = null, Eb = null, Rd = null, He = null, Gi = null,
        Hi = null, Ii = null, Ji = null, Ki = null,
        xh = null, yh = null, wc = null, bc = null, Ia = null, ri = null, Rg = null, Gd = null, Y = null, ab = null,
        fk = null, Hf = null, Ff = null, si = null, Ef = null, Df = null, yf = null, Cf = null, Bf = null, Af = null,
        zf = null, xf = null, wf = null, Tg = null, Sg = null, Oa = null, vi = null, ui = null, ti = null, Wg = null,
        ef = null, ue = null, nb = null, jk = null, lk = null, mk = null, nk = null, kk = null, T = null, Bh = null,
        Ni = null, Ah = null, Sd = null, cg = null, Td = null, dg = null, eg = null, fg = null, Ud = null, Dd = null,
        fc = null;
    ...
    q.destroy = function () {
        if (lb) {
            ...
            p(z) && (z.className = n.empty, z.innerHTML =
                n.empty);
    ...
    q.setCurrentDisplayDate =
        function (a) {
            !xc(a) || r && !db || (a = new Date(a), !U(v, a) && a.getFullYear() >= b.minimumYear && a.getFullYear() <= b.maximumYear && (F(a), x(b.events.onSetDate, a)));
            return q
        };
    ...
    q.setSelectedDatePickerDate = function (a) {
        xc(a) && r && (a = new Date(a), nj(a) && !U(a, Mc) && a.getFullYear() >= b.minimumYear && a.getFullYear() <= b.maximumYear && (a.setHours(0, 0, 0, 0), qd(), Uh(a), x(b.events.onDatePickerDateChanged, a), Mc = a));
        return q
    };
    q.refresh = function () {
        r || La(!0, !0);
    ...
    q.addEvent = function (a, c, d, e) {
        var f = !1;
        if (!r && (e = l(e, !0), R(a.from) && (a.from =
            new Date(a.from)), R(a.to) && (a.to = new Date(a.to)), R(a.repeatEnds) && (a.repeatEnds = new Date(a.repeatEnds)), R(a.created) && (a.created = new Date(a.created)), R(a.lastUpdated) && (a.lastUpdated = new Date(a.lastUpdated)), a.color === b.defaultEventBackgroundColor && (a.color = null), a.colorText === b.defaultEventTextColor && (a.colorText = null), a.colorBorder === b.defaultEventBorderColor && (a.colorBorder = null), a.from <= a.to)) {
            var g = a.from;
            ...
            if (!qb[g].hasOwnProperty(h)) {
                ...
                d = l(d, !0);
                f = G(a.title);
                var q = G(a.description), t = G(a.location), u = G(a.group), v = G(a.url);
                ...
                0 < b.maximumEventTitleLength && f !== n.empty && f.length > b.maximumEventTitleLength && (a.title = a.title.substring(0, b.maximumEventTitleLength));
                0 < b.maximumEventDescriptionLength && q !== n.empty && q.length > b.maximumEventDescriptionLength &&
                (a.description = a.description.substring(0, b.maximumEventDescriptionLength));
                0 < b.maximumEventLocationLength && t !== n.empty && t.length > b.maximumEventLocationLength && (a.location = a.location.substring(0, b.maximumEventLocationLength));
                0 < b.maximumEventGroupLength && u !== n.empty && u.length > b.maximumEventGroupLength && (a.group = a.group.substring(0, b.maximumEventGroupLength));
                v === n.empty || tk(v) || (a.url = n.empty);
                xc(a.created) || (a.created = new Date);
                e && (a.lastUpdated = new Date);
                qb[g][h] = Zk(a);
                f = !0;
                d && x(b.events.onEventAdded,
                    a);
                c && (jb(), Mb(), Ha(), ma())
            }
        }
    ...
    q.updateEvent = function (a, c, d, e) {
        var f = !1;
        !r && (f = q.removeEvent(a, !1, !1)) && (d = l(d, !0), e = l(e, !0), f = q.addEvent(c, d, !1), jb(), f && e && x(b.events.onEventUpdated, c));
        return f
    };
    q.updateEventDateTimes = function (a, c, d, e, f, g) {
        var h = !1;
        r || (f = l(f, !0), g = l(g, !0), xb(function (k) {
            if (k.id ===
                a) return k.from = c, k.to = d, k.repeatEnds = e, h = !0, g && x(b.events.onEventUpdated, k), f && (jb(), Mb(), Ha(), ma()), !0
        }));
        return h
    };
    q.removeEvent = function (a, c, d) {
        var e = !1;
        r || (c = l(c, !0), d = l(d, !0), xb(function (f, g, h) {
            if (h === a) return delete qb[g][h], e = !0, d && x(b.events.onEventRemoved, f), c && (jb(), Mb(), Ha(), ma()), !0
        }));
        return e
    };
    q.clearEvents = function (a, c) {
        r || (a = l(a, !0), c = l(c, !0), qb = {}, c && x(b.events.onEventsCleared), a && (jb(), Mb(), Ha(), ma()));
        return q
    };
    ...
    q.removeExpiredEvents = function (a, b) {
        r || (a = l(a, !0), b = l(b, !0), xb(function (a) {
    ...
    q.addEventType = function (a, b) {
        var c = !1;
        Ba(a) && R(b) && !r && !N.hasOwnProperty(a) && (N[a] = {
            text: b,
            eventEditorInput: null
        }, p(O.visibleEventTypes) && O.visibleEventTypes.push(a), c = !0);
        return c
    };
    q.removeEventType = function (a) {
        var b = !1;
        Ba(a) && !r && N.hasOwnProperty(a) &&
        (delete N[a], b = !0);
        return b
    };
    q.setVisibleEventTypes = function (a, c) {
        if (pa(a) && !r) {
            c = l(c, !0);
            O.visibleEventTypes = [];
            for (var d = a.length, e = 0; e < d; e++) O.visibleEventTypes.indexOf(a[e]) === B.notFound && O.visibleEventTypes.push(a[e]);
            La(!0, !1);
    ...
    q.clearAllGroups = function (a, c) {
        r || (a = l(a, !0), c = l(c, !0), xb(function (a) {
            a.group = null
        }), c && x(b.events.onGroupsCleared), a && (Mb(), Ha(), ma()));
        return q
    };
    q.removeGroup =
        function (a, c, d) {
    ...
    q.setOptions = function (a, c) {
        ...
        Li();
        lb && ((c = l(c, !0)) &&
        x(b.events.onOptionsUpdated, b), lb = !1, r && !db || F(v, !0, !0));
        return q
    };
    ...
    q.addHolidays = function (a, c, d) {
        pa(a) && !r && (c = l(c, !0), d = l(d, !0), b.holidays = b.holidays.concat(a), c && x(b.events.onOptionsUpdated, b), d && F(v, !0, !0));
        return q
    };
    ...
    (function (a, c, d, e, f) {
        ...
        cc = f;
        za = I;
        if (R(za) || fj(za)) pl(ua), u = kb(V, b.searchOptions), u.enabled = l(u.enabled, !0), u.lastSearchText = cb(u.lastSearchText, n.empty), u.not = l(u.not, !1), u.matchCase = l(u.matchCase, !1), u.showAdvanced = l(u.showAdvanced, !1), u.searchTitle = l(u.searchTitle, !0), u.searchLocation = l(u.searchLocation, !1), u.searchDescription =
            l(u.searchDescription, !1), u.searchGroup = l(u.searchGroup, !1), u.searchUrl = l(u.searchUrl, !1), u.startsWith = l(u.startsWith, !1), u.endsWith = l(u.endsWith, !1), u.contains = l(u.contains, !0), u.left = ta(u.left, null), u.top = ta(u.top, null), u.history = ig(u.history, []), F(b.initialDateTime, !0), null !== z && ib(b.openInFullScreenMode) && b.openInFullScreenMode && !r && Wk()
